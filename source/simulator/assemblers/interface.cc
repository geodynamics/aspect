    ...
    namespace Assembly
    {
      namespace Scratch
      {
        ...
        StokesPreconditioner (const FiniteElement<dim> &finite_element,
          ...
          grad_phi_p (stokes_dofs_per_cell /* tmp: 0*/, numbers::signaling_nan<Tensor<1,dim> >()),
      ...
      namespace CopyData
      {
        ...
        StokesPreconditioner (const unsigned int stokes_dofs_per_cell)
          ...
          local_matrix (stokes_dofs_per_cell,
                        stokes_dofs_per_cell),
          local_lumped_mass_approximation (stokes_dofs_per_cell),
        ...
        StokesPreconditioner (const StokesPreconditioner &data)
          ...
          local_lumped_mass_approximation (data.local_lumped_mass_approximation),
