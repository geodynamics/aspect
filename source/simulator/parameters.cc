...
{
  template <int dim>
  Parameters<dim>::Parameters(ParameterHandler &prm, const MPI_Comm mpi_communicator)
  {
  ...
  template <int dim>
  void
  Parameters<dim>::declare_parameters(ParameterHandler &prm, const unsigned int mpi_rank)
  {
    ...
    prm.declare_entry("Resume computation",
                      "false",
    ...
    prm.declare_entry("Max nonlinear iterations in pre-refinement",
                      boost::lexical_cast<std::string>(std::numeric_limits<int>::max()),
                      Patterns::Integer(0),
    ...
    prm.declare_entry("Timing output frequency",
                      "100",
                      Patterns::Integer(0),
    ...
    prm.declare_entry("Use years instead of seconds",
                      "true",
                      Patterns::Bool(),
    ...
    prm.declare_entry("Use conduction timestep",
                      "false",
                      Patterns::Bool(),
    ...
    const std::string allowed_solver_schemes =
    ...
    prm.declare_entry("Nonlinear solver scheme",
                      "single Advection, single Stokes",
    ...
    prm.declare_entry("Nonlinear solver failure strategy",
    ...
    prm.declare_entry("Nonlinear solver tolerance",
                      "1e-5",
                      Patterns::Double(0., 1.),
    ...
    prm.declare_entry("Linear solver failure strategy",
                      "abort",
    ...
    prm.declare_entry("Pressure normalization",
                      "surface",
    ...
    prm.declare_entry("Adiabatic surface temperature",
                      "0.",
                      Patterns::Double(),
    ...
    prm.declare_entry("Output directory LFS stripe count",
                      "0",
                      Patterns::Integer(0),
    ...
    prm.declare_entry("Use operator splitting",
                      "false",
                      Patterns::Bool(),
    ...
    {
      prm.declare_entry("Number of particle systems",
                        "1",
    ...
    {
      prm.declare_entry("Temperature solver tolerance",
                        "1e-12",
                        Patterns::Double(0., 1.),
      ...
      prm.declare_entry("Composition solver tolerance",
                        "1e-12",
                        Patterns::Double(0., 1.),
                        "The relative tolerance up to which the linear system for "
      ...
      {
        prm.declare_entry("GMRES solver restart length",
                          "50",
                          Patterns::Integer(1),
      ...
      {
        prm.declare_entry("Stokes solver type",
                          "default solver",
        ...
        prm.declare_entry("Stokes GMG type",
                          "local smoothing",
        ...
        prm.declare_entry("Use direct solver for Stokes system",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("Use weighted BFBT for Schur complement",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("Krylov method for cheap solver steps",
                          "GMRES",
        ...
        prm.declare_entry("IDR(s) parameter",
                          "2",
                          Patterns::Integer(1),
        ...
        prm.declare_entry("Number of cheap Stokes solver steps",
                          "1000",
                          Patterns::Integer(0),
        ...
        prm.declare_entry("Maximum number of expensive Stokes solver steps",
                          "1000",
                          Patterns::Integer(0),
        ...
        prm.declare_entry("Linear solver A block tolerance",
                          "1e-2",
                          Patterns::Double(0., 1.),
        ...
        prm.declare_entry("Use full A block as preconditioner",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("Force nonsymmetric A block solver",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("Linear solver S block tolerance",
                          "1e-6",
                          Patterns::Double(0., 1.),
      ...
      {
        prm.declare_entry("AMG smoother type",
                          "Chebyshev",
        ...
        prm.declare_entry("AMG output details",
                          "false",
                          Patterns::Bool(),
      ...
      {
        prm.declare_entry("Reaction solver type",
                          "ARKode",
        ...
        prm.declare_entry("Reaction solver relative tolerance",
                          "1e-6",
                          Patterns::Double(0.),
        ...
        prm.declare_entry("Reaction time step",
                          "1000.0",
                          Patterns::Double(0.),
        ...
        prm.declare_entry("Reaction time steps per advection step",
                          "0",
                          Patterns::Integer(0),
      ...
      {
        prm.declare_entry("Diffusion length scale",
                          "1.e4",
                          Patterns::Double(0.),
    ...
    prm.enter_subsection("Formulation");
    {
      ...
      prm.declare_entry("Mass conservation",
                        "ask material model",
      ...
      prm.declare_entry("Temperature equation",
                        "real density",
                        ...
                        "if `Formulation' is set to `custom'. Other formulations ignore "
                        "the value of this parameter.");
      prm.declare_entry("Enable additional Stokes RHS",
                        "false",
                        Patterns::Bool(),
      ...
      prm.declare_entry("Enable elasticity",
                        "false",
                        Patterns::Bool(),
                        "Whether to include the additional elastic terms on the right-hand side of "
                        "the Stokes equation.");
      prm.declare_entry("Enable prescribed dilation",
                        "false",
                        Patterns::Bool(),
    ...
    {
      prm.declare_entry("Include melt transport",
                        "false",
                        Patterns::Bool(),
    ...
    prm.enter_subsection("Mesh refinement");
    {
      ...
      prm.declare_entry("Additional refinement times",
                        ...
                        "'Use years instead of seconds' parameter is set; "
                        "seconds otherwise.");
      prm.declare_entry("Run postprocessors on initial refinement",
                        "false",
                        Patterns::Bool(),
      ...
      prm.declare_entry("Skip solvers on initial refinement",
                        "false",
                        Patterns::Bool(),
                        "Whether or not solvers should be executed during the initial "
                        "adaptive refinement cycles that are run at the start of the "
                        "simulation.");
      prm.declare_entry("Skip setup initial conditions on initial refinement",
                        "false",
                        Patterns::Bool(),
    ...
    {
      prm.declare_entry("Run postprocessors on nonlinear iterations",
                        "false",
                        Patterns::Bool(),
                        "Whether or not the postprocessors should be executed after "
    ...
    prm.enter_subsection("Checkpointing");
    {
      ...
      prm.declare_entry("Number of checkpoints to keep",
                        "3",
                        Patterns::Integer(1),
                        "The number of checkpoint slots to rotate through in the "
                        "output/restart directory. "
                        "Units: None.");
      prm.declare_entry("Resume checkpoint",
                        "0",
                        Patterns::Integer(0),
    ...
    {
      prm.declare_entry("Stokes velocity polynomial degree",
                        "2",
                        Patterns::Integer(1),
                        ...
                        "Units: None.");
      prm.declare_entry("Temperature polynomial degree",
                        "2",
                        Patterns::Integer(1),
                        ...
                        "discontinuous field. "
                        "Units: None.");
      prm.declare_entry("Composition polynomial degree",
                        "2",
                        ...
                        "valid choice. "
                        "Units: None.");
      prm.declare_entry("Use locally conservative discretization",
                        "false",
                        Patterns::Bool(),
      ...
      prm.declare_entry("Use equal order interpolation for Stokes",
                        "false",
                        Patterns::Bool(),
                        ...
                        ":::");
      prm.declare_entry("Use discontinuous temperature discretization",
                        "false",
                        Patterns::Bool(),
      ...
      prm.declare_entry("Use discontinuous composition discretization",
                        "false",
      ...
      {
        prm.declare_entry("Stabilization method",
                          "entropy viscosity",
        ...
        prm.declare_entry("Use artificial viscosity smoothing",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("gamma",
                          ...
                          "Units: None.");
        prm.declare_entry("Discontinuous penalty",
                          "10.",
                          Patterns::Double(0.),
        ...
        prm.declare_entry("Use limiter for discontinuous temperature solution",
                          "false",
                          Patterns::Bool(),
        ...
        prm.declare_entry("Use limiter for discontinuous composition solution",
                          "false",
                          Patterns::List(Patterns::Bool()),
    ...
    {
      prm.declare_entry("Temperature method",
                        "field",
    ...
    prm.enter_subsection("Compositional fields");
    {
      ...
      prm.declare_entry("Minimum volume fraction",
                        "0.0",
      ...
      prm.declare_entry("Types of fields",
                        ...
                        Patterns::List(Patterns::Selection(
                          "chemical composition|stress|strain|grain size|porosity|density|entropy|reaction progress|generic|unspecified")),
      ...
      prm.declare_entry(
        ...
        "",
        Patterns::List(Patterns::Selection(
          "field|particles|volume of fluid|static|melt field|darcy field|prescribed field|prescribed field with diffusion")),
      ...
      prm.declare_entry("Use pressure gradient for darcy field",
                        "false",
                        Patterns::Bool(),
    ...
    {
      prm.declare_entry("Material averaging",
                        "default averaging",
                        Patterns::Selection(MaterialModel::MaterialAveraging::get_averaging_operation_names()),
                        ...
                        "\n\n"
                        "Possible choices: " +
                          MaterialModel::MaterialAveraging::get_averaging_operation_names() +
                          "\n\n"
  ...
  template <int dim>
  void
  Parameters<dim>::parse_parameters(ParameterHandler &prm, const MPI_Comm mpi_communicator)
  {
    // first, make sure that the ParameterHandler parser agrees
    // with the code in main() about the meaning of the "Dimension"
    // parameter
    AssertThrow(prm.get_integer("Dimension") == dim, ExcInternalError());
    ...
    prm.enter_subsection("Particles");
    {
      ...
      Assert(n_particle_managers <= ASPECT_MAX_NUM_PARTICLE_SYSTEMS,
             ExcMessage("You have specified more particle managers (" + Utilities::int_to_string(n_particle_managers) +
                        ") than the maximum amount of particle managers set in CMake (" +
                        Utilities::int_to_string(ASPECT_MAX_NUM_PARTICLE_SYSTEMS) + ")."));
    }
    prm.leave_subsection();
    ...
    nonlinear_solver_failure_strategy = NonlinearSolverFailureStrategy::parse(prm.get("Nonlinear solver failure strategy"));
    linear_solver_failure_strategy    = LinearSolverFailureStrategy::parse(prm.get("Linear solver failure strategy"));
    if (linear_solver_failure_strategy == Parameters<dim>::LinearSolverFailureStrategy::continue_with_nonlinear_solver)
    ...
    prm.enter_subsection("Solver parameters");
    {
      ...
      prm.enter_subsection("Operator splitting parameters");
      {
        ...
        AssertThrow(reaction_time_step > 0, ExcMessage("Reaction time step must be greater than 0."));
        if (convert_to_years == true)
      ...
      if (lfs_stripe_count != 0)
        {
          if (Utilities::MPI::this_mpi_process(mpi_communicator) == 0)
            {
              const std::string command = "lst setstripe -c " + std::to_string(lfs_stripe_count) + ' ' + output_directory;
    ...
    prm.enter_subsection("Mesh refinement");
    {
      ...
      AssertThrow(refinement_fraction >= 0 && coarsening_fraction >= 0, ExcMessage("Refinement/coarsening fractions must be positive."));
      AssertThrow(refinement_fraction + coarsening_fraction <= 1, ExcMessage("Refinement and coarsening fractions must be <= 1."));
      ...
      additional_refinement_times = Utilities::string_to_double(Utilities::split_string_list(prm.get("Additional refinement times")));
      std::sort(additional_refinement_times.begin(), additional_refinement_times.end());
      if (convert_to_years == true)
    ...
    prm.enter_subsection("Nullspace removal");
    {
      ...
      std::vector<std::string> nullspace_names = Utilities::split_string_list(prm.get("Remove nullspace"));
      ...
      for (const auto &nullspace_name : nullspace_names)
        {
          if (nullspace_name == "net rotation")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_rotation);
          else if (nullspace_name == "net surface rotation")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_surface_rotation);
          else if (nullspace_name == "angular momentum")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::angular_momentum);
          else if (nullspace_name == "net translation")
            nullspace_removal =
              typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_translation_x |
                                              NullspaceRemoval::net_translation_y | (dim == 3 ? NullspaceRemoval::net_translation_z : 0));
          else if (nullspace_name == "net x translation")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_translation_x);
          else if (nullspace_name == "net y translation")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_translation_y);
          else if (nullspace_name == "net z translation")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::net_translation_z);
          else if (nullspace_name == "linear x momentum")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::linear_momentum_x);
          else if (nullspace_name == "linear y momentum")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::linear_momentum_y);
          else if (nullspace_name == "linear z momentum")
            nullspace_removal = typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::linear_momentum_z);
          else if (nullspace_name == "linear momentum")
            nullspace_removal =
              typename NullspaceRemoval::Kind(nullspace_removal | NullspaceRemoval::linear_momentum_x |
    ...
    prm.enter_subsection("Checkpointing");
    {
      ...
      additional_checkpoint_times = Utilities::string_to_double(Utilities::split_string_list(prm.get("Additional checkpoint times")));
      std::sort(additional_checkpoint_times.begin(), additional_checkpoint_times.end());
      if (convert_to_years == true)
...
#ifndef DEAL_II_WITH_ZLIB
      AssertThrow((checkpoint_time_secs == 0) && (checkpoint_steps == 0),
                  ExcMessage("You need to have deal.II configured with the `libz' "
    ...
    prm.enter_subsection("Discretization");
    {
      ...
      composition_degrees    = Utilities::possibly_extend_from_1_to_N(Utilities::string_to_unsigned_int(Utilities::split_string_list(
                                                                     prm.get("Composition polynomial degree"))),
      ...
      use_locally_conservative_discretization      = prm.get_bool("Use locally conservative discretization");
      use_equal_order_interpolation_for_stokes     = prm.get_bool("Use equal order interpolation for Stokes");
      use_discontinuous_temperature_discretization = prm.get_bool("Use discontinuous temperature discretization");
      use_discontinuous_composition_discretization =
        Utilities::possibly_extend_from_1_to_N(Utilities::string_to_bool(
                                                 Utilities::split_string_list(prm.get("Use discontinuous composition discretization"))),
                                               n_compositional_fields,
      ...
      prm.enter_subsection("Stabilization parameters");
      {
        ...
        stabilization_c_R = Utilities::possibly_extend_from_1_to_N(Utilities::string_to_double(Utilities::split_string_list(prm.get("cR"))),
                                                                   ...
                                                                   "cR");
        stabilization_beta =
          Utilities::possibly_extend_from_1_to_N(Utilities::string_to_double(Utilities::split_string_list(prm.get("beta"))),
                                                 n_compositional_fields + 1,
                                                 "beta");

        stabilization_gamma                                = prm.get_double("gamma");
        discontinuous_penalty                              = prm.get_double("Discontinuous penalty");
        use_limiter_for_discontinuous_temperature_solution = prm.get_bool("Use limiter for discontinuous temperature solution");
        use_limiter_for_discontinuous_composition_solution = Utilities::possibly_extend_from_1_to_N(
          Utilities::string_to_bool(Utilities::split_string_list(prm.get("Use limiter for discontinuous composition solution"))),
          n_compositional_fields,
        ...
        global_composition_max_preset = Utilities::possibly_extend_from_1_to_N(Utilities::string_to_double(Utilities::split_string_list(
                                                                                 prm.get("Global composition maximum"))),
                                                                               n_compositional_fields,
                                                                               "Global composition maximum");
        global_composition_min_preset = Utilities::possibly_extend_from_1_to_N(Utilities::string_to_double(Utilities::split_string_list(
                                                                                 prm.get("Global composition minimum"))),
                                                                               n_compositional_fields,
      ...
      AssertThrow((use_locally_conservative_discretization || use_equal_order_interpolation_for_stokes) || (stokes_velocity_degree > 1),
      ...
      AssertThrow(!(use_locally_conservative_discretization && use_equal_order_interpolation_for_stokes),
    ...
    prm.enter_subsection("Temperature field");
    {
      std::string x_temperature_method = prm.get("Temperature method");
    ...
    prm.enter_subsection("Compositional fields");
    {
      ...
      AssertThrow((names_of_compositional_fields.size() == 0) || (names_of_compositional_fields.size() == n_compositional_fields),
      ...
      if (include_melt_transport && std::find(names_of_compositional_fields.begin(), names_of_compositional_fields.end(), "porosity") ==
      ...
      const std::vector<int> n_normalized_fields =
        Utilities::string_to_int(Utilities::split_string_list(prm.get("List of normalized fields")));
      normalized_fields = std::vector<unsigned int>(n_normalized_fields.begin(), n_normalized_fields.end());
      ...
      for (const unsigned int field : normalized_fields)
        {
          AssertThrow(field < n_compositional_fields,
                      ExcMessage(
                        "Invalid input parameter file: An entry in List of normalized fields is larger then the number of fields."));
        }
      ...
      std::vector<std::string> x_compositional_field_types = Utilities::split_string_list(prm.get("Types of fields"));

      AssertThrow((x_compositional_field_types.size() == 1) || (x_compositional_field_types.size() == n_compositional_fields),
            ...
            if (names_of_compositional_fields[i].find("stress") != std::string::npos)
              {
                ...
                AssertThrow(
                  enable_elasticity,
                  ExcMessage(
                    "Even though elasticity is not enabled, ASPECT deduced a stress field type from the name of a compositional field. "
      ...
      std::vector<std::string> x_compositional_field_methods = Utilities::split_string_list(prm.get("Compositional field methods"));

      AssertThrow((x_compositional_field_methods.size() == 0) || (x_compositional_field_methods.size() == 1) ||
      ...
      Assert(compositional_field_methods.size() == 0, ExcInternalError());
      ...
      volume_of_fluid_tracking_enabled =
        (std::count(compositional_field_methods.begin(), compositional_field_methods.end(), AdvectionFieldMethod::volume_of_fluid) > 0);
      ...
      const std::vector<std::string> x_mapped_particle_properties = Utilities::split_string_list(prm.get("Mapped particle properties"));
      ...
      AssertThrow((x_mapped_particle_properties.size() == number_of_particle_fields) || (x_mapped_particle_properties.size() == 0),
      ...
      if (std::find(compositional_field_methods.begin(), compositional_field_methods.end(), AdvectionFieldMethod::fem_darcy_field) !=
          compositional_field_methods.end())
        {
          const unsigned int porosity_idx =
            std::find(names_of_compositional_fields.begin(), names_of_compositional_fields.end(), "porosity") -
          ...
          AssertThrow(compositional_field_methods[porosity_idx] == AdvectionFieldMethod::fem_darcy_field,
                      ExcMessage(
                        "When using the Darcy advection field method, the porosity field must be advected with the Darcy method."));
        }
      ...
      for (const auto &p : x_mapped_particle_properties)
        {
          ...
          AssertThrow(compositional_field_methods[compositional_field_index] == AdvectionFieldMethod::particles,
          ...
          if ((particle_property.size() > 3) && (particle_property[particle_property.size() - 1] == ']'))
            {
              particle_property.erase(--particle_property.end());

              // this handles the (rare) case of multi digit components
              while ((particle_property[particle_property.size() - 1] >= '0') && (particle_property[particle_property.size() - 1] <= '9'))
                {
              ...
              AssertThrow(particle_property[particle_property.size() - 1] == '[',
                          ExcMessage("Problem in parsing a component selector from the string <" + split_parts[1] +
                                     ">. A component selector has to be of the "
          ...
          mapped_particle_properties.insert(
            std::make_pair(compositional_field_index, std::make_pair(particle_property, std::atoi(component.c_str()))));
        }
      ...
      for (const std::string &field_name : compositional_fields_with_disabled_boundary_entropy_viscosity)
        {
          AssertThrow(std::find(names_of_compositional_fields.begin(), names_of_compositional_fields.end(), field_name) !=
                        names_of_compositional_fields.end(),
    ...
    prm.enter_subsection("Material model");
    {
      material_averaging = MaterialModel::MaterialAveraging::parse_averaging_operation_name(prm.get("Material averaging"));
    }
    prm.leave_subsection();
  ...
  template <int dim>
  void
  Parameters<dim>::parse_geometry_dependent_parameters(ParameterHandler &prm, const GeometryModel::Interface<dim> &geometry_model)
  {
    prm.enter_subsection("Mesh deformation");
    {
      ...
      try
        {
          const std::vector<types::boundary_id> x_fixed_heat_flux_boundary_indicators =
            geometry_model.translate_symbolic_boundary_names_to_ids(
              Utilities::split_string_list(prm.get("Fixed heat flux boundary indicators")));
          fixed_heat_flux_boundary_indicators =
            std::set<types::boundary_id>(x_fixed_heat_flux_boundary_indicators.begin(), x_fixed_heat_flux_boundary_indicators.end());
        }
      catch (const std::string &error)
        {
          AssertThrow(false,
                      ExcMessage("While parsing the entry <Boundary heat flux model/Fixed heat flux "
...
#define INSTANTIATE(dim) \
  template Parameters<dim>::Parameters(ParameterHandler &prm, const MPI_Comm mpi_communicator); \
  template void Parameters<dim>::declare_parameters(ParameterHandler &prm, const unsigned int mpi_rank); \
  template void Parameters<dim>::parse_parameters(ParameterHandler &prm, const MPI_Comm mpi_communicator); \
