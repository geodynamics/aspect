...
namespace aspect
{
  namespace MeshDeformation
  {
    ...
    {
      this->get_computing_timer().enter_subsection("Parallel Unstructured Interface: Compute Velocity Constraints on Boundary");
      ...
      this->get_computing_timer().leave_subsection("Parallel Unstructured Interface: Compute Velocity Constraints on Boundary");
    }
    ...
    {
      this->get_computing_timer().enter_subsection("Parallel Unstructured Interface: Set Evaluation Points");
      ...
      this->get_computing_timer().leave_subsection("Parallel Unstructured Interface: Set Evaluation Points");
    }
