...
namespace aspect
{
  namespace HeatingModel
  {
    ...
    template <int dim>
    void
    ShearHeatingMelt<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Heating model");
      {
        prm.enter_subsection("Shear heating with melt");
        {
        }
    ...
    template <int dim>
    void
    ShearHeatingMelt<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Heating model");
      {
        prm.enter_subsection("Shear heating with melt");
...
namespace aspect
{
  namespace HeatingModel
  {
    ASPECT_REGISTER_HEATING_MODEL(ShearHeatingMelt,
                                  ...
                                  "of migrating melt. For full shear heating, "
