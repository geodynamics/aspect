      ...
      for (unsigned int q = 0; q < heating_model_outputs.heating_source_terms.size(); ++q)
        {
          ...
          const std::vector<double> volume_fractions = MaterialModel::MaterialUtilities::compute_fractions_from_compositional_fields(material_model_inputs.composition[q],
