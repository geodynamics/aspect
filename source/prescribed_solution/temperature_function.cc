...
namespace aspect
{
  namespace PrescribedSolution
  {
    ...
    template <int dim>
    void
    TemperatureFunction<dim>::constrain_solution(const typename DoFHandler<dim>::active_cell_iterator & /*cell*/,
              ...
              if (indicator > 0.5)
                {
                  ...
                  solution[q] = prescribed_temperature_function.value(Utilities::convert_array_to_point<dim>(point.get_coordinates()), 0);
                }
            }
        }
    }
