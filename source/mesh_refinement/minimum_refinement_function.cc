...
namespace aspect
{
  namespace MeshRefinement
  {
          ...
          if (cell->is_locally_owned())
            {
              ...
              const double minimum_refinement_level =
                min_refinement_level.value(Utilities::convert_array_to_point<dim>(point.get_coordinates()));
    ...
    template <int dim>
    void
    MinimumRefinementFunction<dim>::declare_parameters(ParameterHandler &prm)
    {
