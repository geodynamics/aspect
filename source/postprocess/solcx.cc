...
/*
  ...
  This is based on a file from http://www.underworldproject.org/
  "released under a mixture of BSD and LGPL licenses."
  */
...
int main( int argc, char **argv )
{
	...
	for (i=0;i<=n_p;i++){
	  for(j=0;j<=n_p;j++){
	    x = static_cast<double>(i)/n_p;
	    z = static_cast<double>(j)/n_p;
