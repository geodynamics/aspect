...
namespace aspect
{
  namespace Postprocess
  {
    ASPECT_REGISTER_POSTPROCESSOR(FluidVelocityStatistics,
                                  ...
                                  "maximum fluid velocity in the computational domain. The "
                                  "fluid velocity is either the melt velocity or the Darcy "
                                  "velocity, depending on the advection method chosen for the "
                                  "porosity compositional field. ")
  }
}
