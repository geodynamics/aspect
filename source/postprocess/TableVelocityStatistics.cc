...
namespace aspect
{
  namespace Postprocess
  {
    ...
    TableVelocityStatistics<dim>::execute (TableHandler &statistics)
    {
      ...
      statistics.add_value ("RMS velocity (Dimensionless)",
                                vrmsDimless);
      statistics.set_precision ("RMS velocity (Dimensionless)", 6);
      statistics.set_scientific ("RMS velocity (Dimensionless)", true);
