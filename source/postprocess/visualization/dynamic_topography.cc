...
namespace aspect
{
  namespace Postprocess
  {
    ...
    {
      template <int dim>
      DynamicTopography<dim>::DynamicTopography()
        : DataPostprocessorScalar<dim>("dynamic_topography", update_quadrature_points)
        , Interface<dim>("m")
      {}
      ...
      template <int dim>
      void
      DynamicTopography<dim>::evaluate_vector_field(const DataPostprocessorInputs::Vector<dim> &input_data,
