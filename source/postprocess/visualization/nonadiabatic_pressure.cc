...
namespace aspect
{
  namespace Postprocess
  {
    ...
    {
      template <int dim>
      NonadiabaticPressure<dim>::NonadiabaticPressure()
        : DataPostprocessorScalar<dim>("nonadiabatic_pressure", update_values | update_quadrature_points)
        , Interface<dim>("Pa")
      {}
      ...
      template <int dim>
      void
      NonadiabaticPressure<dim>::evaluate_vector_field(const DataPostprocessorInputs::Vector<dim> &input_data,
