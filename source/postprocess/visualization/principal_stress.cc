...
namespace aspect
{
  namespace Postprocess
  {
    ...
    {
      template <int dim>
      PrincipalStress<dim>::PrincipalStress()
      ...
      PrincipalStress<dim>::get_names() const
      {
      ...
      PrincipalStress<dim>::get_data_component_interpretation() const
      {
      ...
      template <int dim>
      UpdateFlags
      PrincipalStress<dim>::get_needed_update_flags() const
      {
      ...
      template <int dim>
      void
      PrincipalStress<dim>::evaluate_vector_field(const DataPostprocessorInputs::Vector<dim> &input_data,
      ...
      PrincipalStress<dim>::declare_parameters(ParameterHandler &prm)
      {
        prm.enter_subsection("Postprocess");
        {
          prm.enter_subsection("Visualization");
          {
            ...
            {
              prm.declare_entry("Use deviatoric stress",
                                "false",
                                Patterns::Bool(),
