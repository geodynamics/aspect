/*
  Copyright (C) 2026 - 2026 by the authors of the ASPECT code.
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
      ...
      GeneralCompositionReaction<dim>::declare_parameters(ParameterHandler &prm)
      {
        prm.enter_subsection("General composition reaction");
        {
          prm.declare_entry("Selected compositional fields",
                            ...
                            "A list that determines which compositional fields are stored for particles "
                            "in this particle manager. The value 'all' selects every compositional field.");
        }
      ...
      template<int dim>
      void GeneralCompositionReaction<dim>::parse_parameters(ParameterHandler &prm)
      {
        prm.enter_subsection("General composition reaction");
        {
