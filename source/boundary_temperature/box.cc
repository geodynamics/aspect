...
namespace aspect
{
  namespace BoundaryTemperature
  {
    ...
    template <int dim>
    double
    Box<dim>::boundary_temperature(const types::boundary_id boundary_indicator, const Point<dim> & /*position*/) const
    {
    ...
    template <int dim>
    double
    Box<dim>::minimal_temperature(const std::set<types::boundary_id> &fixed_boundary_ids) const
    {
    ...
    template <int dim>
    double
    Box<dim>::maximal_temperature(const std::set<types::boundary_id> &fixed_boundary_ids) const
    {
      if (fixed_boundary_ids.empty())
