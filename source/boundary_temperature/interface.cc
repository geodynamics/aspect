...
// -------------------------------- their setup and selection at run time
    ...
    namespace
    {
      ...
      // correspond to the arguments given to the register_boundary_temperature
      // function.
      //
      ...
      std::list<BoundaryTemperatureInfo> *registered_boundary_temperatures = 0;
    }
                                   ...
                                   Interface<dim> * (*factory_function) ())
    {
      ...
      if (registered_boundary_temperatures == 0)
        registered_boundary_temperatures = new std::list<BoundaryTemperatureInfo>();
    ...
    {
      Assert (registered_boundary_temperatures != 0, ExcInternalError());
