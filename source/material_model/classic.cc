...
#include <aspect/material_model/classic.h>
...
template <int dim>
void
Classic<dim>::declare_parameters (ParameterHandler &prm)
{
    prm.enter_subsection("Material model");
    {
        prm.enter_subsection("Classic model");
        {
            ...
            prm.declare_entry ("Density differential for compositional field 1", "0",
                               ...
                               "to make the density depend on these fields. In this classic material "
...
template <int dim>
void
Classic<dim>::parse_parameters (ParameterHandler &prm)
{
    prm.enter_subsection("Material model");
    {
        prm.enter_subsection("Classic model");
        {
            ...
            if (thermal_viscosity_exponent!=0.0 && reference_T == 0.0)
                AssertThrow(false, ExcMessage("Error: Material model classic with Thermal viscosity exponent can not have reference_T=0."));
