...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    {
      static internal::radial_viscosity_lookup table("DataDir/steinberger/radial_visc.txt");
    ...
    density (const double temperature,
             ...
             const Point<dim> &position) const
    {
      static internal::thermal_exp_lookup table("DataDir/steinberger/thermal_expansivity.d");
