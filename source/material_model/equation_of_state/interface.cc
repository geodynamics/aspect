      ...
      for (unsigned int c=0; c<eos_outputs.densities.size(); ++c)
        {
          ...
          eos_outputs.thermal_diffusion_coefficients[c] =
            MaterialModel::MaterialUtilities::phase_average_value(phase_function_values, n_phases_per_composition, eos_outputs_all_phases.thermal_diffusion_coefficients, c);   
        }
    }
  }
}
