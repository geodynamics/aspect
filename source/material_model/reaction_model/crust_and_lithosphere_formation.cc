  ...
  namespace MaterialModel
  {
    namespace ReactionModel
    {
      ...
      CrustLithosphereFormation<dim>::declare_parameters(ParameterHandler &prm)
      {
        ...
        prm.declare_entry("Crustal thickness",
                          "7000",
                          Patterns::Double(),
        ...
        prm.declare_entry("Lithosphere thickness",
                          ...
                          "Units: \\si{\\meter}.");
        prm.declare_entry(
          "Minimum upwelling angle for crust formation",
          "30",
          ...
          "Units: \\si{\\degree}.");
        prm.declare_entry(
          "Minimum upwelling angle for lithosphere formation",
          "30",
          Patterns::Double(0, 90),
          ...
          "Units: \\si{\\degree}.");
        prm.declare_entry("Harzburgite profile in lithosphere",
                          "linear",
      ...
      CrustLithosphereFormation<dim>::parse_parameters(ParameterHandler &prm)
      {
        ...
        minimum_upwelling_angle_for_lithosphere =
          prm.get_double("Minimum upwelling angle for lithosphere formation") * constants::degree_to_radians;
...
namespace aspect
{
  namespace MaterialModel
  {
    namespace ReactionModel
    {
#define INSTANTIATE(dim) template class CrustLithosphereFormation<dim>;
