    ...
    namespace Rheology
    {
      ...
      CompositionalViscosityPrefactors<dim>::declare_parameters (ParameterHandler &prm)
      {
        ...
        prm.declare_entry ("Viscosity prefactor scheme", "none",
                           Patterns::Selection("none|HK04 olivine hydration|peng_robinson76_fugacity"),
                           ...
                           "'peng_robinson76_fugacity'. 'HK04 olivine hydration' calculates "
                           "the viscosity change due to hydrogen incorporation into olivine "
                           "following Hirth & Kohlstedt 2004 (10.1029/138GM06). "
                           "'peng_robinson76_fugacity' estimates the effective pressure "
                           "(fugacity) of a configurable pure fluid from temperature and "
                           "adiabatic pressure using the Peng-Robinson equation of state. "
                           "The default parameter values are appropriate for H2O fluid/vapor. Under the assumption of"
                           "fluid-saturated conditions, the resulting fugacity prefactor "
                           "f_H2O^(-r/n) is applied to diffusion and dislocation creep using "
                           "their respective configured exponents, so that "
                           "eta=eta_base*f_H2O^(-r/n). Fugacity "
                           "depends only on temperature and pressure and is therefore "
                           "independent of composition, although r/n may be configured "
                           "separately for each compositional field. "
                           "This represents the experimentally observed weakening of minerals "
                           "by water (Karato et al., 1986, 10.1029/JB091iB08p08151), with the "
                           "water-fugacity term in the creep flow law following Mei & Kohlstedt "
                           "(2000, 10.1029/2000JB900180). 'none' does not modify the viscosity. "
                           "Units: none.");
        prm.declare_entry ("Critical temperature", "647.3",
                           ...
                           "It must be changed, together with 'Critical pressure' and "
                           "'Acentric factor', when applying the equation of state to "
                           "another fluid. "
                           "Units: K.");
        prm.declare_entry ("Critical pressure", "22.12e6",
                           ...
                           "equation of state. This parameter is only used when "
                           "'Viscosity prefactor scheme' is 'peng_robinson76_fugacity'. "
                           "It must be changed, together with 'Critical temperature' and "
                           "'Acentric factor', when applying the equation of state to "
                           "another fluid. "
                           "Units: Pa.");
        prm.declare_entry ("Acentric factor", "0.344",
                           ...
                           "of Peng & Robinson (1976, "
                           "10.1021/i160057a011). This parameter is only used for the "
                           "'peng_robinson76_fugacity' scheme. Units: none.");
      }
      ...
      CompositionalViscosityPrefactors<dim>::parse_parameters (ParameterHandler &prm)
      {
        ...
        if (viscosity_prefactor_scheme == peng_robinson76_fugacity)
          {
