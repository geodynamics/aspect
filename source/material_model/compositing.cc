...
namespace aspect
{
  namespace MaterialModel
  {
                               ...
                               typename Interface<dim>::MaterialModelOutputs &out) const
    {
      ...
      // Also let the base output have addional named outputs,
      // as this might change the behavior of the base models.
      // TODO Note that this call only creates additional outputs
      // generated by material models, not by other places.
