...
namespace aspect
{
  namespace InitialTemperature
  {
    ...
    template <int dim>
    double
    RandomGaussianPerturbation<dim>::initial_temperature(const Point<dim> &position) const
    {
