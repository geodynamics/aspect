...
namespace aspect
{
  namespace InitialTemperature
  {
    ASPECT_REGISTER_INITIAL_TEMPERATURE_MODEL(AsciiDataLayered,
                                              ...
                                              "in ascii format. Each file defines the surface of an isotherm. "
                                              ...
                                              "the last column always contains the isotherm depth. "
                                              "The first column needs to ascend first (looping over "
                                              "isotherms at the same horizontal position), "
                                              ...
                                              "radial distance of the point from the bottom "
