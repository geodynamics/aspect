      ...
      prm.enter_subsection("Boundary composition model");
      {
        prm.enter_subsection("Box with lithosphere boundary indicators");
        {
          prm.declare_entry ("Left composition", "",
                             ...
                             "entries as there are compositional fields prescribed by the plugin on the left boundary. Units: none.");
          prm.declare_entry ("Right composition", "",
                             Patterns::List(Patterns::Double ()),
                             "A comma separated list of composition boundary values "
                             "at the right boundary (at maximal $x$-value). This list must have as many "
                             "entries as there are compositional fields prescribed by the plugin on the right boundary. Units: none.");
          prm.declare_entry ("Left composition lithosphere", "",
                             Patterns::List(Patterns::Double ()),
                             "A comma separated list of composition boundary values "
                             "at the left boundary (at minimal $x$-value). This list must have as many "
                             "entries as there are compositional fields prescribed by the plugin on the left lithosphere "
                             "boundary. Units: none.");
          prm.declare_entry ("Right composition lithosphere", "",
                             Patterns::List(Patterns::Double ()),
                             "A comma separated list of composition boundary values "
                             "at the right boundary (at maximal $x$-value). This list must have as many "
                             "entries as there are compositional fields prescribed by the plugin on the right lithosphere "
                             "boundary. Units: none.");
          prm.declare_entry ("Bottom composition", "",
                             ...
                             "entries as there are compositional fields prescribed by the plugin on the bottom boundary. Units: none.");
          prm.declare_entry ("Top composition", "",
                             Patterns::List(Patterns::Double ()),
                             "A comma separated list of composition boundary values "
                             "at the top boundary (at maximal $y$-value in 2d, or maximal "
                             "$z$-value in 3d). This list must have as many "
                             "entries as there are compositional fields prescribed by the plugin on the top boundary. Units: none.");
          if (dim==3)
            {
              prm.declare_entry ("Front composition", "",
                                 ...
                                 "entries as there are compositional fields prescribed by the plugin on the front boundary. Units: none.");
              prm.declare_entry ("Back composition", "",
                                 Patterns::List(Patterns::Double ()),
                                 "A comma separated list of composition boundary values "
                                 "at the back boundary (at maximal $y$-value). This list must have as many "
                                 "entries as there are compositional fields prescribed by the plugin on the back boundary. Units: none.");
              prm.declare_entry ("Front composition lithosphere", "",
                                 ...
                                 "entries as there are compositional fields prescribed by the plugin on the front lithosphere boundary. "
                                 "Units: none.");
              prm.declare_entry ("Back composition lithosphere", "",
                                 ...
                                 "entries as there are compositional fields prescribed by the plugin on the back lithosphere boundary. "
                                 "Units: none.");
            }
        }
          ...
          if (fixed_boundary_indicators.count(f) != 0)
            AssertThrow (composition_values[f].size() == fixed_boundary_indicators.size(),
                         ExcMessage (std::string("The specification of boundary composition values for the `box with "
                                                 ...
                                                 "are compositional fields prescribed by the plugin on that boundary. However, for boundary indicator "
                                                 +
