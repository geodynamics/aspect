...
output.write("#include <aspect/macros.h>\n\n")

partition_is_open = False
...
for line in lines:
    ...
    # files, but importantly no 'export {' statement:
    elif partition_is_open == False and match_aspect_open.match(line):
        output.write(
            "module aspect : " + implementation_module_partition_name + ";\n\n"
        )
        ...
        # Register that we've already opened the module partition:
        partition_is_open = True
