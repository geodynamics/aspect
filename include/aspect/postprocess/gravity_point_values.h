  ...
  namespace Postprocess
  {
    ...
    class GravityPointValues : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        /**
         * Parameter for the domain of points spiral sampling method:
         */
         ...
         * for a domain of points or a list of points.
         */
        enum SamplingScheme
        {
          map,
        ...
        /**
         * Specify the domain of points sampling method determining how gravity calculation
         * is performed: equiangular or spiral equidistant.
         */
        enum SamplingMethod
        {
          equiangular,
