...
#ifndef _aspect_postprocess_visualization_mass_error_face_integral_h
#define _aspect_postprocess_visualization_mass_error_face_integral_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * computes the cell-wise value of
       ...
       */
      template <int dim>
      class MassErrorFaceIntegral
        : public CellDataVectorCreator<dim>,
          public SimulatorAccess<dim>
      {
        public:
          /**
           * Evaluate the solution for the mass error.
           *
