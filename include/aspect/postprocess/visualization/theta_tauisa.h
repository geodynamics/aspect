...
#ifndef _aspect_postprocess_visualization_theta_tauisa_h
#define _aspect_postprocess_visualization_theta_tauisa_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       */
      template<int dim>
      class Theta: public CellDataVectorCreator<dim>, public SimulatorAccess<dim>
      {
        public:
       ...
       */
      template<int dim>
      class tauISA: public CellDataVectorCreator<dim>, public SimulatorAccess<dim>
      {
        public:
