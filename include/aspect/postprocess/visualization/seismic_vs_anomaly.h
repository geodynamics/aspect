...
#ifndef __aspect__postprocess_visualization_seismic_vs_anomaly_h
#define __aspect__postprocess_visualization_seismic_vs_anomaly_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * the computed computed seismic anomaly in $V_s$ for graphical
       * output.
       */
      template <int dim>
      class SeismicVsAnomaly : public CellDataVectorCreator<dim>,
