...
#ifndef __aspect__postprocess_visualization_seismic_vp_anomaly_h
#define __aspect__postprocess_visualization_seismic_vp_anomaly_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * the computed computed seismic anomaly in $V_p$ for graphical
       * output.
       */
      template <int dim>
      class SeismicVpAnomaly : public CellDataVectorCreator<dim>,
