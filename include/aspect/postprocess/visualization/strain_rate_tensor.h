...
#ifndef _aspect_postprocess_visualization_strain_rate_tensor_h
#define _aspect_postprocess_visualization_strain_rate_tensor_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       */
      template <int dim>
      class StrainRateTensor : public DataPostprocessorTensor<dim>, public SimulatorAccess<dim>, public Interface<dim>
      {
        public:
          StrainRateTensor();
