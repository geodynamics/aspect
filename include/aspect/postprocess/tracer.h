...
namespace aspect
{
    namespace Postprocess
    {
        ...
        public:
            ...
            void setPosition(Point<dim> new_pos) { _pos = new_pos; };
            Point<dim> getPosition(void) const { return _pos; };
            
            void setOriginalPos(Point<dim> orig_pos) { _pos0 = orig_pos; };
            Point<dim> getOriginalPos(void) const { return _pos0; };
            
            void setVelocity(Point<dim> new_velocity) { _velocity = new_velocity; };
            Point<dim> getVelocity(void) const { return _velocity; };
            
            unsigned int getID(void) const { return _id; };
            
            void getCell(int &level, int &index) const { level = _cell_level; index = _cell_index; };
            void setCell(int new_level, int new_index) { _cell_level = new_level; _cell_index = new_index; };
            
            void setLocal(bool new_local) { _is_local = new_local; };
