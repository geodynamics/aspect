    ...
    namespace Assembly
    {
      namespace Scratch
      {
        ...
        struct VolumeOfFluidSystem
        {
             ...
             */
            VolumeOfFluidSystem &
            operator=(const VolumeOfFluidSystem &) = default;
  ...
  namespace Assemblers
  {
    ...
    class VolumeOfFluidAssembler : public SimulatorAccess<dim>
    {
      public:
         ...
         */
        void
        local_assemble_volume_of_fluid_system(const VolumeOfFluidField<dim>                          &field,
         ...
         */
        void
        local_assemble_boundary_face_volume_of_fluid_system(const VolumeOfFluidField<dim>                          &field,
                                                            const bool                                              update_from_old,
                                                            const typename DoFHandler<dim>::active_cell_iterator   &cell,
         ...
         */
        void
        local_assemble_internal_face_volume_of_fluid_system(const VolumeOfFluidField<dim>                          &field,
                                                            const bool                                              update_from_old,
                                                            const typename DoFHandler<dim>::active_cell_iterator   &cell,
                                                            const unsigned int                                      face_no,
                                                            internal::Assembly::Scratch::VolumeOfFluidSystem<dim>  &scratch,
         ...
         */
        void
        set_volume_fraction_threshold(const double value);
    };
  }
}
