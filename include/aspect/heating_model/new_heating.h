...
#ifndef _aspect_heating_model_new_heating_h
#define _aspect_heating_model_new_heating_h
...
namespace aspect
{
  namespace HeatingModel
  {
     ...
     */
    template <int dim>
    class NewHeating : public Interface<dim>, public Utilities::AsciiDataBoundary<dim>
    {
      public:
        /**
