  ...
  namespace HeatingModel
  {
    ...
    class Interface : public Plugins::InterfaceBase
    {
      public:
         ...
         */
        virtual MaterialModel::MaterialProperties::Property
    ...
    class Manager : public Plugins::ManagerBase<Interface<dim>>, public SimulatorAccess<dim>
    {
      public:
         ...
         */
        template <typename HeatingModelType, typename = typename std::enable_if_t<std::is_base_of<Interface<dim>, HeatingModelType>::value>>
        DEAL_II_DEPRECATED const HeatingModelType &
        ...
        DeclException1(ExcHeatingModelNameNotFound,
                       std::string,
                       << "Could not find entry <" << arg1 << "> among the names of registered heating model objects.");
    };
...
#define ASPECT_REGISTER_HEATING_MODEL(classname, name, description) \
  ...
  { \
    aspect::internal::Plugins::RegisterHelper<aspect::HeatingModel::Interface<2>, classname<2>> dummy_##classname##_2d( \
      &aspect::HeatingModel::Manager<2>::register_heating_model, name, description); \
    aspect::internal::Plugins::RegisterHelper<aspect::HeatingModel::Interface<3>, classname<3>> dummy_##classname##_3d( \
      &aspect::HeatingModel::Manager<3>::register_heating_model, name, description); \
  }
  }
}
