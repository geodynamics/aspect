...
#ifndef __aspect__particle_interpolator_least_squares_h
#define __aspect__particle_interpolator_least_squares_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class LeastSquares : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**
