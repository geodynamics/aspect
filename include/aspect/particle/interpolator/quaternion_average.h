...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
      ...
      /**
       * @brief Symmetry group of the underlying rotations that are supposed to be averaged.
      ...
      class QuaternionAverage : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        ...
        private:
          ...
          /**
           * The name of the symmetry group of the orientations that are supposed to be averaged.
           * This variable is read from the parameter file through a parameter
           * called 'Symmetry group'.
           */
