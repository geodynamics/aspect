...
#ifndef _aspect_particle_property_reference_position_h
#define _aspect_particle_property_reference_position_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class ReferencePosition : public Interface<dim>
      {
        public:
          /**
           ...
           * value.
           *
           * @param [in] position The current particle reference position.
