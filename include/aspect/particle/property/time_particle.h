...
#ifndef _aspect_particle_property_time_particle_h
#define _aspect_particle_property_time_particle_h
...
namespace aspect
{
  namespace Particle
  {
    ...
    {
      /**
       * A class that sets particle properties to the current time.
       *
