...
namespace aspect
{
  ...
  class Simulator
  {
    public:
      ...
      /**
       * Initialize LinearAlgebra vectors: solution, old_solution, and old_old_solution
       * from binary input data that has been previously generated with ASPECT by enabling
       * the postprocessor, 'velocity binary'
       */
      void init_load_binary_solution();

      /**
       * Initialize time, time_step, timestep_number, and old_time_step corresponding to
       * the initalized binary solution. This information is generated by the postprocessor
       * 'velocity binary'
       */
      void init_time_input();

      /**
       * Update the time_step and old_time_step from binary data generated by the postprocessor
       * 'velocity binary' corresponding to solution to be loaded for t_{n+1}.
       */
      void update_time_input();
