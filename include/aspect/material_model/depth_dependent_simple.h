...
#ifndef __aspect__model_depth_dependent_simple_h
#define __aspect__model_depth_dependent_simple_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class DepthDependentSimple : public MaterialModel::InterfaceCompatibility<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
