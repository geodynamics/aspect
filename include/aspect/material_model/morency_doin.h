...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    /**
     * A material model based on the rheology described in (Morency and Doin, 2004):
     * Brittle-ductile rheology with a viscosity strongly depending on temperature
     * and composition. Using pseudo-brittle rheology limits the strength of the
     * lithosphere at low temperature.
     *
     * The effective viscosity is defined as the harmonic mean of two stress-dependent
     * viscosity functions: a simple temperature/pressure-dependent, non-newtonian viscosity,
     * and a more strongly stress-dependent, "plastic" viscosity.
     *
     ...
     *
     * Several model parameters (reference densities, activation energies, thermal
     * expansivities, and stress exponents-- both viscous and plastic) can be defined
     * per-compositional field. If a list of values is given for any of these parameters,
     * the weighted sum of the values based on volume fractions of the compositional fields
     * is used in their place. If only one value is given for any of these parameters,
     * all compositions are assigned the same value. The first value in the list is the
     * value assigned to "background mantle" (regions where the sum of the compositional
     * fields is < 1.0).
     *
     * For more on the material model and its applications, see:
     * Morency, C., and M‐P. Doin. "Numerical simulations of the mantle lithosphere
     * delamination." Journal of Geophysical Research: Solid Earth (1978–2012) 109.B3 (2004)
     *
    ...
    class MorencyDoin : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        /**
         * From multicomponent material model:
