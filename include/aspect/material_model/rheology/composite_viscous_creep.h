...
#ifndef _aspect_material_model_rheology_composite_viscous_creep_h
#define _aspect_material_model_rheology_composite_viscous_creep_h
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    namespace Rheology
    {
      ...
      template <int dim>
      class CompositeViscousCreep : public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
           */
          CompositeViscousCreep();
