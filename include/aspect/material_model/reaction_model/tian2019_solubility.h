    ...
    namespace ReactionModel
    {
      ...
      class Tian2019Solubility : public ::aspect::SimulatorAccess<dim>
      {
        public:
           ...
           */
          double
          melt_fraction(const MaterialModel::MaterialModelInputs<dim> &in, const double mass_frac_porosity, unsigned int q) const;
           ...
           */
          std::vector<double>
          tian_equilibrium_bound_water_content(const MaterialModel::MaterialModelInputs<dim> &in, unsigned int q) const;
        ...
        private:
           ...
           */
          std::vector<double>
            LR_peridotite_poly_coeffs{-19.0609, 168.983, -630.032, 1281.84, -1543.14, 1111.88, -459.142, 95.4143, 1.97246};
          ...
          std::vector<std::vector<double>> devolatilization_enthalpy_changes{LR_peridotite_poly_coeffs,
                                                                             LR_gabbro_poly_coeffs,
                                                                             LR_MORB_poly_coeffs,
                                                                             LR_sediment_poly_coeffs};

          std::vector<std::vector<double>> water_mass_fractions{csat_peridotite_poly_coeffs,
                                                                csat_gabbro_poly_coeffs,
                                                                csat_MORB_poly_coeffs,
                                                                csat_sediment_poly_coeffs};

          std::vector<std::vector<double>> devolatilization_onset_temperatures{Td_peridotite_poly_coeffs,
