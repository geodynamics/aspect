  ...
  namespace MaterialModel
  {
    ...
    class Multicomponent : public MaterialModel::InterfaceCompatibility<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        double thermal_alpha; //thermal expansivity
        double reference_specific_heat;
        double k_value; // thermal conductivity
        ...
        std::vector<double> composition_viscosity_prefactor;
        std::vector<double> composition_delta_rho;
