...
#ifndef _aspect_initial_temperature_plate_cooling_h
#define _aspect_initial_temperature_plate_cooling_h
...
namespace aspect
{
  namespace InitialTemperature
  {
     ...
     */
    template <int dim>
    class PlateCooling : public Interface<dim>, public Utilities::AsciiDataBoundary<dim>
    {
      public:
