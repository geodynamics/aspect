...
#ifndef _aspect_simulator_solver_stokes_matrix_based_h
#define _aspect_simulator_solver_stokes_matrix_based_h
...
namespace aspect
{
  ...
  {
    /**
     * A matrix-based iterative solver for the Stokes equations.
     */
    template <int dim>
    class MatrixBased: public Interface<dim>
    {
      public:
        /**
         * Constructor.
         *
         * TODO: As for the other Stokes solver classes, find ways to avoid
         * using the direct Simulator reference.
         */
      ...
      private:
        /**
         * A reference to the simulator class to access some difficult to
         * reach member variables.
         * TODO: As for the other Stokes solver classes, find ways to avoid
         * using this direct reference.
         */
        Simulator<dim> &sim;
    };
  }
