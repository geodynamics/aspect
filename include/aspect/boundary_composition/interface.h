  ...
  namespace BoundaryComposition
  {
    ...
    class Interface
    {
      public:
         ...
         */
        virtual
        double minimal_composition (const std::set<types::boundary_id>& fixed_boundary_ids =
         ...
         */
        virtual
        double maximal_composition (const std::set<types::boundary_id>& fixed_boundary_ids =
                                    std::set<types::boundary_id>()) const = 0;
