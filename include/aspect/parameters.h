...
namespace aspect
{
  ...
  struct Parameters
  {
       ...
       */
      void
      parse_parameters(ParameterHandler &prm, const MPI_Comm mpi_communicator);
       ...
       */
      void
      parse_geometry_dependent_parameters(ParameterHandler &prm, const GeometryModel::Interface<dim> &geometry_model);
