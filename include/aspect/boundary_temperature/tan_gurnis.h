  ...
  namespace BoundaryTemperature
  {
    ...
    class TanGurnis : public Interface<dim>
    {
      public:
         ...
         */
        virtual
        double minimal_temperature (const std::set<types::boundary_id_t>& fixed_boundary_ids) const;
         ...
         */
        virtual
        double maximal_temperature (const std::set<types::boundary_id_t>& fixed_boundary_ids) const;
    };
  }
}
