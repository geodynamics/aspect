...
#     on the differential strain rate leads to the conversion factor
#
#         F_s = 3^((n + 1) / 2) / 2
#
# where:
...
# Mantle: Dry Olivine Dislocation Creep from Hirth & Kohlstedt (2004)
pfct_hk04_olv_disl_rprt = 1.1e5 # Original reported prefactor in units of MPa^-n micrometers^m
sexp_hk04_olv_disl_rprt = 3.5    # Original reported stress exponent
gexp_hk04_olv_disl_rprt = 0      # Original reported grain size exponent

# Convert prefactor to units of Pa^-n meters^m s^-1
pfct_hk04_olv_disl_unit = (pfct_hk04_olv_disl_rprt) * \
                           (1.e-6**sexp_hk04_olv_disl_rprt) * \
                           (1.e-6**gexp_hk04_olv_disl_rprt)

# Calculate prefactor scaling term
pfct_hk04_olv_disl_sfac = 3.**((sexp_hk04_olv_disl_rprt+1.)/2.) / 2


# Calculated modified prefactor term for ASPECT
pfct_hk04_olv_disl_aspt = pfct_hk04_olv_disl_unit * pfct_hk04_olv_disl_sfac

print('')
print('Hirth & Kohlstedt (2004) - Dry Olivine Dislocation Prefactor Scaling = ', pfct_hk04_olv_disl_sfac)
print('Hirth & Kohlstedt (2004) - Dry Olivine Dislocation Prefactor ASPECT  = ', pfct_hk04_olv_disl_aspt)
print('')