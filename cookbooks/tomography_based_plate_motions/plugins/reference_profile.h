...
#ifndef _aspect_cookbooks_tomography_based_plate_motions_reference_profile_h
#define _aspect_cookbooks_tomography_based_plate_motions_reference_profile_h
...
namespace aspect
{
  namespace AdiabaticConditions
  {
     ...
     */
    template <int dim>
    class ReferenceProfile : public Interface<dim>
    {
      public:
        /**
      ...
      private:
        ...
        /**
         * Vectors of values of temperatures, pressures and densities on a transect into
