...
# The tutorial model inputs live below a second-level directory.
convection-box/: dummy
	@$(def); run_prm $@ convection-box.prm
	@$(def); run_prm $@ tutorial-onset-of-convection/model_input/convection-box.prm
	@$(def); run_prm $@ tutorial-onset-of-convection/model_input/convection-box2.prm
	@$(def); run_prm $@ tutorial-onset-of-convection/model_input/tutorial.prm
...
# Use the checked-in velocity fixtures instead of files generated by pvpython.
global_regional_coupling/: dummy
	@$(def); run_prm $@ free_slip_boundaries.prm $$'subsection Mesh refinement\n  set Initial global refinement = 0\nend\nsubsection Postprocess\n  set List of postprocessors = velocity statistics\nend'
	@$(def); run_prm $@ global_regional_coupling.prm $$'subsection Boundary velocity model\n  subsection Ascii data model\n    set Data directory = $$ASPECT_SOURCE_DIR/data/test/cookbook_files/\n  end\nend\nsubsection Mesh refinement\n  set Initial global refinement = 0\nend\nsubsection Postprocess\n  set List of postprocessors = velocity statistics\nend'
