...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class MeltSRB : public MaterialModel::MeltInterface<dim>, public ::aspect::SimulatorAccess<dim>, public MaterialModel::MeltFractionModel<dim>
    {
      public:
        /**
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    MeltSRB<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Melt srb");
        {
    ...
    template <int dim>
    void
    MeltSRB<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Melt srb");
    ...
    template <int dim>
    void
    MeltSRB<dim>::create_additional_named_outputs (MaterialModel::MaterialModelOutputs<dim> &out) const
    {
      if (this->get_parameters().use_operator_splitting
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(MeltSRB,
                                   "melt srb",
                                   "A material model  modified from melt global"
                                   "that implements a simple formulation of the "
