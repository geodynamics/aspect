...
I=150
declare -a P=(150) #0 5 10 50 15 150 20 25 30) #0 5 10 15 20 150) # 1 2 3 4 5 10 15 25 50 100)
declare -a LS=(0) # 5 10)
declare -a ST=(1e-20)
declare -a LT=("1e-6") #"5e-13" "1e-13" "1e-14" "1e-15" "1e-16") # "1e-8") # "1e-8") #"1e-5") # "1e-8")
...
nohup mpirun -np $processes ../../.././aspect $infilename > $outfilename 2>$errorfilename

grep "Relative nonlinear residual (total" $outfilename > $outplotfilename
