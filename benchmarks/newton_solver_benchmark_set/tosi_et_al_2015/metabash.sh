...
declare -a NSA=("SPD" "none") # "symmetric" "none") # "Symmetric" "PD" "none") #Use Newton stabilization A block
declare -a UFS=("truefalse") #"false") # use failsafe
declare -a RSM=("truefalse") # "true") # use residual scaling
declare -a LS=(0-25) #(10) # line search
declare -a COMP=(0) # copmressibiltiy
#declare -a phi=(30)
declare -a ST=("1e-20" "1e-2") # "1e-4")
declare -a UDS=("false") #true") #"true" #"false"
declare -a SF=("9.99e-1") # "9.9e-1") # "9.99e-1" "1")
...
-e "s/declare -a LS.*/declare -a LS=(0 25)/g" \
