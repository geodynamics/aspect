...
plot "results_Q2_beta0.0_cR0.0.dat" using 1:3  with linespoints, \
     "results_Q2_beta0.078_cR0.33.dat" using 1:3 with linespoints, \
     "results_Q2_beta0.052_cR0.11.dat" using 1:3  with linespoints, \
     "results_Q2_beta0.026_cR0.06.dat" using 1:3 with linespoints
