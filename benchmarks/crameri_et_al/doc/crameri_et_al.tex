...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{cookbooks/benchmarks/crameri_et_al/doc/crameri_1_comparison.pdf}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{cookbooks/benchmarks/crameri_et_al/doc/crameri_2_comparison.pdf}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=1.0\textwidth]{cookbooks/benchmarks/crameri_et_al/doc/crameri_2_convergence.pdf}
  \end{center}
