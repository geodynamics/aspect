...
def main() -> None:
    ...
    parser.add_argument(
        "--plugin",
        type=Path,
        default=BENCHMARK_DIR / "libadjoint_dynamic_topography_2d_spherical.so",
    ...
    parser.add_argument("--cells-per-property", type=int, default=32)
    parser.add_argument("--selection", choices=["quantile", "largest"], default="largest")
