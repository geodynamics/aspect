...
epanechnikov_df = read_statistics('output_removal/output-epanechnikov/statistics')
...
epanechnikov_constant_df = read_statistics('output_removal/output-epanechnikov-constant-velocity/statistics')
