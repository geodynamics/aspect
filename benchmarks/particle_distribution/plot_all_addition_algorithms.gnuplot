...
set terminal png
set output "cell-stdev-mean-oscillate-addition.png"
replot
...
set terminal png
set output "cell-stdev-mean-constant-addition.png"
replot
...
set terminal png
set output "ave-score-oscillate-addition.png"
replot
...
plot "output_addition/output-cutoff-w1-constant-velocity/statistics" using 2:21 title "deal.ii-cutoff-w1 constant V", \
     ...
     "output_addition/output-histogram-constant-velocity/statistics" using 2:23 title "histogram", \
...
set terminal png
set output "ave-score-constant-addition.png"
replot
...
set terminal png
set output "max-score-oscillate-addition.png"
replot
...
set terminal png
set output "max-score-constant-addition.png"
replot
