...
<img src="vel.png" title="fig:" id="fig:hollow-sphere-vp" alt="Figure" />
<img src="vel2.png" title="fig:" id="fig:hollow-sphere-vp" alt="Figure" />
<img src="pressure.png" title="fig:" id="fig:hollow-sphere-vp" alt="Figure" />

```{figure-md} fig:hollow-sphere-errors
<embed src="cookbooks/benchmarks/hollow_sphere/doc/errors_hollowsphere.pdf" />
