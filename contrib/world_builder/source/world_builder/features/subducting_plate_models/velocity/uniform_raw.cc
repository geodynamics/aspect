...
#include "world_builder/features/subducting_plate_models/velocity/uniform_raw.h"
  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      namespace Velocity
      {
        ...
        WB_REGISTER_FEATURE_SUBDUCTING_PLATE_VELOCITY_MODEL(UniformRaw, uniform raw)
      } // namespace Velocity
    } // namespace SubductingPlateModels
  } // namespace Features
} // namespace WorldBuilder
