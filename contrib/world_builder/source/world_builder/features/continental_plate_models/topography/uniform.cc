...
#include "world_builder/features/continental_plate_models/topography/uniform.h"
    ...
    namespace ContinentalPlateModels
    {
      namespace Topography
      {
        ...
        Uniform::declare_entries(Parameters &prm, const std::string & /*unused*/)
        {
          ...
          prm.declare_entry("topography", Types::Double(0),
        ...
        double
        Uniform::get_topography(const Point<3> & /*position_in_cartesian_coordinates*/,
