...
execute_process(
  COMMAND ${MPIEXEC_EXECUTABLE} -np 2  ${TEST_PROGRAM} ${TEST_ARGS} 
  WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/CPP_MPI/ 
...
if( TEST_RESULT_VAR )
	message( FATAL_ERROR "Failed: Test program ${TEST_PROGRAM} exited != 0 (${TEST_RESULT_VAR}) with mpi ${MPIEXEC_EXECUTABLE}.\n Test args where: ${TEST_ARGS}\n Error: ${TEST_ERROR_VAR}" )
