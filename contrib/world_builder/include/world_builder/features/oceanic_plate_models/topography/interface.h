...
#ifndef WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_TOPOGRAPHY_INTERFACE_H
#define WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_TOPOGRAPHY_INTERFACE_H
  ...
  namespace Features
  {
    ...
    namespace OceanicPlateModels
    {
      namespace Topography
      {
         ...
         */
#define WB_REGISTER_FEATURE_OCEANIC_PLATE_TOPOGRAPHY_MODEL(classname,name) \
