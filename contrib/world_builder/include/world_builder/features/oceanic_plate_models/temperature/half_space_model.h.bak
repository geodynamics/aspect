...
#ifndef WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_TEMPERATURE_HALF_SPACE_MODEL_H
#define WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_TEMPERATURE_HALF_SPACE_MODEL_H
  ...
  namespace Features
  {
    ...
    namespace OceanicPlateModels
    {
      namespace Temperature
      {
         ...
         */
        class HalfSpaceModel final: public Interface
        {
          public:
            /**
             * constructor
             */
            HalfSpaceModel(WorldBuilder::World *world);
