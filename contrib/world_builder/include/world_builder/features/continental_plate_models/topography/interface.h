...
#ifndef WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_TOPOGRAPHY_INTERFACE_H
#define WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_TOPOGRAPHY_INTERFACE_H
      ...
      namespace Topography
      {
        ...
        class Interface
        {
          public:
            ...
            /**
             * takes topography and position and returns a topography.
             */
            virtual
         ...
         */
#define WB_REGISTER_FEATURE_CONTINENTAL_PLATE_TOPOGRAPHY_MODEL(classname,name) \
