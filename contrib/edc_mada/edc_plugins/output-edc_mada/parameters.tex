...
{\it Value:} /Users/kodi/src/Aspect/aspect\_opendap/edc\_mada/edc\_plugins/libedc\_plugin.so
...
{\it Value:} single Advection, iterated Stokes
...
{\it Possible values:} Any one of single Advection, single Stokes, iterated Advection and Stokes, single Advection, iterated Stokes, no Advection, iterated Stokes, iterated Advection and Newton Stokes, single Advection, no Stokes, IMPES, iterated IMPES, iterated Stokes, Newton Stokes, Stokes only, Advection only, first timestep only, single Stokes
...
\item {\it Parameter name:} {\tt Read from url}
\phantomsection\label{parameters:Read from url}
\label{parameters:Read_20from_20url}


\index[prmindex]{Read from url}
\index[prmindexfull]{Read from url}
{\it Value:} false
...
{\it Description:} A boolean to determine if the data file to be read in is located in a directory on the machine, or if it will be accessed via a given URL.
...
{\it Value:} crust, mantle\_lithosphere
...
{\it Value:} Boussinesq approximation
...
`lithosphere': Specify the composition in terms of an explicit formula. The format of these functions follows the syntax understood by the muparser library, see Section~\ref{sec:muparser-format}.
...
{\it Possible values:} A comma-separated list of any of ascii data, function, lithosphere, porosity
\item {\it Parameter name:} {\tt List of model operators}
...
{\it Possible values:} Any one of ascii data, function, lithosphere, porosity, unspecified
\end{itemize}
...
\subsection{Parameters in section \tt Initial composition model/Lithosphere}
\label{parameters:Initial_20composition_20model/Lithosphere}

\begin{itemize}
\item {\it Parameter name:} {\tt LAB isotherm}
\phantomsection\label{parameters:Initial composition model/Lithosphere/LAB isotherm}
\label{parameters:Initial_20composition_20model/Lithosphere/LAB_20isotherm}


\index[prmindex]{LAB isotherm}
\index[prmindexfull]{Initial composition model!Lithosphere!LAB isotherm}
{\it Value:} 1673
...
{\it Description:} Temperature at the base of the lithosphere. Units: $K.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Moho}
\phantomsection\label{parameters:Initial composition model/Lithosphere/Moho}
\label{parameters:Initial_20composition_20model/Lithosphere/Moho}


\index[prmindex]{Moho}
\index[prmindexfull]{Initial composition model!Lithosphere!Moho}
{\it Value:} 30000.0
...
{\it Description:} Moho depth. Units: $m.
...
{\it Value:} /Users/kodi/src/Aspect/aspect\_opendap/edc\_mada/input\_files/
...
`upper mantle': A material model for edge driven convection model. There reference density, of the crust is 2700 $kg/m^3$ and 3400 $kg/m^3$ for the mantle. The rheology of the lithosphere and the sublithospheric mantle folows dislocation creep and diffusion creep flow laws respectively (Karato and Wu, 1993)
...
{\it Possible values:} Any one of Steinberger, ascii reference profile, averaging, compositing, composition reaction, depth dependent, diffusion dislocation, drucker prager, dynamic friction, grain size, latent heat, latent heat melt, melt global, melt simple, multicomponent, nondimensional, perplex lookup, simple, simple compressible, simpler, upper mantle, visco plastic, viscoelastic, unspecified
\end{itemize}
...
{\it Possible values:} Any one of Steinberger, ascii reference profile, averaging, compositing, composition reaction, depth dependent, diffusion dislocation, drucker prager, dynamic friction, grain size, latent heat, latent heat melt, melt global, melt simple, multicomponent, nondimensional, perplex lookup, simple, simple compressible, simpler, upper mantle, visco plastic, viscoelastic
...
\subsection{Parameters in section \tt Material model/Upper mantle}
\label{parameters:Material_20model/Upper_20mantle}

\begin{itemize}
\item {\it Parameter name:} {\tt Activation energie for diffusion creep}
\phantomsection\label{parameters:Material model/Upper mantle/Activation energie for diffusion creep}
\label{parameters:Material_20model/Upper_20mantle/Activation_20energie_20for_20diffusion_20creep}


\index[prmindex]{Activation energie for diffusion creep}
\index[prmindexfull]{Material model!Upper mantle!Activation energie for diffusion creep}
{\it Value:} 3.75e5
...
{\it Description:} Aactivation energies, $E_a$, for background mantle Units: $J / mol$


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Activation energie for dislocation creep}
\phantomsection\label{parameters:Material model/Upper mantle/Activation energie for dislocation creep}
\label{parameters:Material_20model/Upper_20mantle/Activation_20energie_20for_20dislocation_20creep}


\index[prmindex]{Activation energie for dislocation creep}
\index[prmindexfull]{Material model!Upper mantle!Activation energie for dislocation creep}
{\it Value:} 5.3e5
...
{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Activation volume for diffusion creep}
\phantomsection\label{parameters:Material model/Upper mantle/Activation volume for diffusion creep}
\label{parameters:Material_20model/Upper_20mantle/Activation_20volume_20for_20diffusion_20creep}


\index[prmindex]{Activation volume for diffusion creep}
\index[prmindexfull]{Material model!Upper mantle!Activation volume for diffusion creep}
{\it Value:} 6e-6
...
{\it Description:} List of activation volumes, $V_a$, for background mantle Units: $m^3 / mol$


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Activation volume for dislocation creep}
\phantomsection\label{parameters:Material model/Upper mantle/Activation volume for dislocation creep}
\label{parameters:Material_20model/Upper_20mantle/Activation_20volume_20for_20dislocation_20creep}


\index[prmindex]{Activation volume for dislocation creep}
\index[prmindexfull]{Material model!Upper mantle!Activation volume for dislocation creep}
{\it Value:} 14e-6
...
{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Base model}
\phantomsection\label{parameters:Material model/Upper mantle/Base model}
\label{parameters:Material_20model/Upper_20mantle/Base_20model}


\index[prmindex]{Base model}
\index[prmindexfull]{Material model!Upper mantle!Base model}
{\it Value:} visco plastic


{\it Default:} simpler


{\it Description:} The name of a material model that will be used for the crustal viscosity. Valid values for this parameter are the names of models that are also valid for the ``Material models/Model name'' parameter. See the documentation for that for more information.


{\it Possible values:} Any one of Steinberger, ascii reference profile, averaging, compositing, composition reaction, depth dependent, diffusion dislocation, drucker prager, dynamic friction, grain size, latent heat, latent heat melt, melt global, melt simple, multicomponent, nondimensional, perplex lookup, simple, simple compressible, simpler, upper mantle, visco plastic, viscoelastic
\item {\it Parameter name:} {\tt Composition viscosity prefactor}
\phantomsection\label{parameters:Material model/Upper mantle/Composition viscosity prefactor}
\label{parameters:Material_20model/Upper_20mantle/Composition_20viscosity_20prefactor}


\index[prmindex]{Composition viscosity prefactor}
\index[prmindexfull]{Material model!Upper mantle!Composition viscosity prefactor}
{\it Value:} 1.0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Denisity adiabatic condition}
\phantomsection\label{parameters:Material model/Upper mantle/Denisity adiabatic condition}
\label{parameters:Material_20model/Upper_20mantle/Denisity_20adiabatic_20condition}


\index[prmindex]{Denisity adiabatic condition}
\index[prmindexfull]{Material model!Upper mantle!Denisity adiabatic condition}
{\it Value:} true
...
{\it Description:} Use adiabatic condition for density


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt Density differential for compositional field 1}
\phantomsection\label{parameters:Material model/Upper mantle/Density differential for compositional field 1}
\label{parameters:Material_20model/Upper_20mantle/Density_20differential_20for_20compositional_20field_201}


\index[prmindex]{Density differential for compositional field 1}
\index[prmindexfull]{Material model!Upper mantle!Density differential for compositional field 1}
{\it Value:} 0
...
{\it Possible values:} A floating point number $v$ such that $-\text{MAX\_DOUBLE} \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Grain size}
\phantomsection\label{parameters:Material model/Upper mantle/Grain size}
\label{parameters:Material_20model/Upper_20mantle/Grain_20size}


\index[prmindex]{Grain size}
\index[prmindexfull]{Material model!Upper mantle!Grain size}
{\it Value:} 0.01
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Grain size exponent for diffusion creep}
\phantomsection\label{parameters:Material model/Upper mantle/Grain size exponent for diffusion creep}
\label{parameters:Material_20model/Upper_20mantle/Grain_20size_20exponent_20for_20diffusion_20creep}


\index[prmindex]{Grain size exponent for diffusion creep}
\index[prmindexfull]{Material model!Upper mantle!Grain size exponent for diffusion creep}
{\it Value:} 3
...
{\it Description:} $m_diffusion$, for background mantle Units: None


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Maximum viscosity}
\phantomsection\label{parameters:Material model/Upper mantle/Maximum viscosity}
\label{parameters:Material_20model/Upper_20mantle/Maximum_20viscosity}


\index[prmindex]{Maximum viscosity}
\index[prmindexfull]{Material model!Upper mantle!Maximum viscosity}
{\it Value:} 1e26
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Minimum strain rate}
\phantomsection\label{parameters:Material model/Upper mantle/Minimum strain rate}
\label{parameters:Material_20model/Upper_20mantle/Minimum_20strain_20rate}


\index[prmindex]{Minimum strain rate}
\index[prmindexfull]{Material model!Upper mantle!Minimum strain rate}
{\it Value:} 1.4e-18
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Minimum viscosity}
\phantomsection\label{parameters:Material model/Upper mantle/Minimum viscosity}
\label{parameters:Material_20model/Upper_20mantle/Minimum_20viscosity}


\index[prmindex]{Minimum viscosity}
\index[prmindexfull]{Material model!Upper mantle!Minimum viscosity}
{\it Value:} 1e17
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Prefactor for diffusion creep}
\phantomsection\label{parameters:Material model/Upper mantle/Prefactor for diffusion creep}
\label{parameters:Material_20model/Upper_20mantle/Prefactor_20for_20diffusion_20creep}


\index[prmindex]{Prefactor for diffusion creep}
\index[prmindexfull]{Material model!Upper mantle!Prefactor for diffusion creep}
{\it Value:} 1.5e-15
...
{\it Description:} Viscosity prefactor, $A$, for background mantle,  Units: $Pa^{-n_{diffusion}} m^{n_{diffusion}/m_{diffusion}} s^{-1}$


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Prefactor for dislocation creep}
\phantomsection\label{parameters:Material model/Upper mantle/Prefactor for dislocation creep}
\label{parameters:Material_20model/Upper_20mantle/Prefactor_20for_20dislocation_20creep}


\index[prmindex]{Prefactor for dislocation creep}
\index[prmindexfull]{Material model!Upper mantle!Prefactor for dislocation creep}
{\it Value:} 6.52e-16
...
{\it Description:} Viscosity prefactor, $A$, for background mantle, Units: $Pa^{-n_{dislocation}} m^{n_{dislocation}/m_{dislocation}} s^{-1}$


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Reference compressibility}
\phantomsection\label{parameters:Material model/Upper mantle/Reference compressibility}
\label{parameters:Material_20model/Upper_20mantle/Reference_20compressibility}


\index[prmindex]{Reference compressibility}
\index[prmindexfull]{Material model!Upper mantle!Reference compressibility}
{\it Value:} 4e-12
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Reference density}
\phantomsection\label{parameters:Material model/Upper mantle/Reference density}
\label{parameters:Material_20model/Upper_20mantle/Reference_20density}


\index[prmindex]{Reference density}
\index[prmindexfull]{Material model!Upper mantle!Reference density}
{\it Value:} 3400
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Reference specific heat}
\phantomsection\label{parameters:Material model/Upper mantle/Reference specific heat}
\label{parameters:Material_20model/Upper_20mantle/Reference_20specific_20heat}


\index[prmindex]{Reference specific heat}
\index[prmindexfull]{Material model!Upper mantle!Reference specific heat}
{\it Value:} 1250
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Reference strain rate}
\phantomsection\label{parameters:Material model/Upper mantle/Reference strain rate}
\label{parameters:Material_20model/Upper_20mantle/Reference_20strain_20rate}


\index[prmindex]{Reference strain rate}
\index[prmindexfull]{Material model!Upper mantle!Reference strain rate}
{\it Value:} 1.0e-15
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Reference temperature}
\phantomsection\label{parameters:Material model/Upper mantle/Reference temperature}
\label{parameters:Material_20model/Upper_20mantle/Reference_20temperature}


\index[prmindex]{Reference temperature}
\index[prmindexfull]{Material model!Upper mantle!Reference temperature}
{\it Value:} 293
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Reference viscosity}
\phantomsection\label{parameters:Material model/Upper mantle/Reference viscosity}
\label{parameters:Material_20model/Upper_20mantle/Reference_20viscosity}


\index[prmindex]{Reference viscosity}
\index[prmindexfull]{Material model!Upper mantle!Reference viscosity}
{\it Value:} 1e22
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Stress exponent for diffusion creep}
\phantomsection\label{parameters:Material model/Upper mantle/Stress exponent for diffusion creep}
\label{parameters:Material_20model/Upper_20mantle/Stress_20exponent_20for_20diffusion_20creep}


\index[prmindex]{Stress exponent for diffusion creep}
\index[prmindexfull]{Material model!Upper mantle!Stress exponent for diffusion creep}
{\it Value:} 1
...
{\it Description:} $n_dislocation$, for background mantle and compositional fields, Units: None


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Stress exponent for dislocation creep}
\phantomsection\label{parameters:Material model/Upper mantle/Stress exponent for dislocation creep}
\label{parameters:Material_20model/Upper_20mantle/Stress_20exponent_20for_20dislocation_20creep}


\index[prmindex]{Stress exponent for dislocation creep}
\index[prmindexfull]{Material model!Upper mantle!Stress exponent for dislocation creep}
{\it Value:} 3.5
...
{\it Description:} Stress exponent, $n_dislocation$, for background mantle, Units: None


{\it Possible values:} A list of 0 to 4294967295 elements where each element is [A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$]
\item {\it Parameter name:} {\tt Thermal conductivity}
\phantomsection\label{parameters:Material model/Upper mantle/Thermal conductivity}
\label{parameters:Material_20model/Upper_20mantle/Thermal_20conductivity}


\index[prmindex]{Thermal conductivity}
\index[prmindexfull]{Material model!Upper mantle!Thermal conductivity}
{\it Value:} 4.7
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Thermal expansion coefficient}
\phantomsection\label{parameters:Material model/Upper mantle/Thermal expansion coefficient}
\label{parameters:Material_20model/Upper_20mantle/Thermal_20expansion_20coefficient}


\index[prmindex]{Thermal expansion coefficient}
\index[prmindexfull]{Material model!Upper mantle!Thermal expansion coefficient}
{\it Value:} 2e-5
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Thermal viscosity exponent}
\phantomsection\label{parameters:Material model/Upper mantle/Thermal viscosity exponent}
\label{parameters:Material_20model/Upper_20mantle/Thermal_20viscosity_20exponent}


\index[prmindex]{Thermal viscosity exponent}
\index[prmindexfull]{Material model!Upper mantle!Thermal viscosity exponent}
{\it Value:} 0.0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Viscosity averaging scheme}
\phantomsection\label{parameters:Material model/Upper mantle/Viscosity averaging scheme}
\label{parameters:Material_20model/Upper_20mantle/Viscosity_20averaging_20scheme}


\index[prmindex]{Viscosity averaging scheme}
\index[prmindexfull]{Material model!Upper mantle!Viscosity averaging scheme}
{\it Value:} harmonic
...
{\it Possible values:} Any one of arithmetic, harmonic, geometric, maximum composition
\item {\it Parameter name:} {\tt Water content}
\phantomsection\label{parameters:Material model/Upper mantle/Water content}
\label{parameters:Material_20model/Upper_20mantle/Water_20content}


\index[prmindex]{Water content}
\index[prmindexfull]{Material model!Upper mantle!Water content}
{\it Value:} 1000
...
{\it Description:} Water conten for dry olivine, $E_a$, for background mantle Units: $J / mol$
...
{\it Value:} 6.52e-16, 7.13e-18, 6.52e-16
...
{\it Value:} visualization, velocity statistics, basic statistics, depth average
...
{\it Value:} temperature,  viscosity, velocity magnitude
...
{\it Value:} viscosity, density, strain rate
