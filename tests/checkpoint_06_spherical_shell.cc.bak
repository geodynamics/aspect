...
int f()
{
  ...
  command = ("cd output-checkpoint_06_spherical_shell ; "
             "(cat " ASPECT_SOURCE_DIR "/tests/checkpoint_06_spherical_shell.prm "
             " ; "
  ...
  ret = system ("cd output-checkpoint_06_spherical_shell ; "
                "cp output1.tmp/solution/solution-00005.0000.gnuplot solution-00005.0000.gnuplot1;"
                "cp output2.tmp/solution/solution-00005.0000.gnuplot solution-00005.0000.gnuplot2;"
