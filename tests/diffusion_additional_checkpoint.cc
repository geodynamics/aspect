...
int f()
{
  ...
  command = ("cd output-diffusion_additional_checkpoint ; "
             "(cat " ASPECT_SOURCE_DIR "/tests/diffusion_additional_checkpoint.prm "
             " ; "
  ...
  ret = system ("cd output-diffusion_additional_checkpoint ; "
