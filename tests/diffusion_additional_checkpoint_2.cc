...
int f()
{
  ...
  command = ("cd output-diffusion_additional_checkpoint_2 ; "
             "(cat " ASPECT_SOURCE_DIR "/tests/diffusion_additional_checkpoint_2.prm "
             " ; "
  ...
  ret = system ("cd output-diffusion_additional_checkpoint_2 ; "
