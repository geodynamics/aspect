    ...
    class Update : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        ...
        update()
        {
          ...
          std::cout << "Updating boundary heat flux to time step " << timestep << '!' << std::endl;
        }
...
namespace aspect
{
  namespace BoundaryHeatFlux
  {
    ASPECT_REGISTER_BOUNDARY_HEAT_FLUX_MODEL(Update, "heatflux update", "Heat flux boundary to test the update and initialize functions.")
  }
}
