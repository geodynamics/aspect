...
int f()
{
  ...
  command = ("cd output-diffusion_additional_checkpoint_3 ; "
             "(cat " ASPECT_SOURCE_DIR "/tests/diffusion_additional_checkpoint_3.prm "
             " ; "
  ...
  ret = system ("cd output-diffusion_additional_checkpoint_3 ; "
