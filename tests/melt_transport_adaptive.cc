...
{
  template <int dim>
  class MeltVelocityRefinement : public MeshRefinement::Interface<dim>, public SimulatorAccess<dim>
  {
    public:
      /**
  ...
  template <int dim>
  class PCRefinement : public MeshRefinement::Interface<dim>, public SimulatorAccess<dim>
  {
    public:
      /**
       * Execute this mesh refinement criterion.
      ...
      execute(Vector<float> &indicators) const
      {
          ...
          if (cell->is_locally_owned())
            {
              ...
              const double p_c_scale = dynamic_cast<const MaterialModel::MeltInterface<dim> *>(&this->get_material_model())
              ...
              for (unsigned int i = 0; i < this->get_fe().base_element(pc_base_index).dofs_per_cell; ++i)
                {
                  const unsigned int system_local_dof = this->get_fe().component_to_system_index(pc_component_index,
        ...
        DerivativeApproximation::approximate_gradient(this->get_mapping(), this->get_dof_handler(), vec, indicators, pc_component_index);
  ...
  template <int dim>
  class TestMeltMaterial : public MaterialModel::MeltInterface<dim>, public SimulatorAccess<dim>
  {
    public:
      virtual bool
        ...
        for (unsigned int i = 0; i < in.n_evaluation_points(); ++i)
          {
            ...
            double reactionterm;
            reactionterm = (0.8544665250e4 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) -
                            0.4950000000e1 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) +
                            0.3245696667e4 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) -
                            0.4687000001e3 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) +
                            0.160e3 * std::exp(-0.120e3 * x * x - 0.400e3 * x * z - 0.420e3 * z * z + z + 0.1e1) * x * x +
                            0.3992000000e3 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) * z +
                            0.1600000000e1 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) * x -
                            0.1399880000e4 * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) * x +
                            0.8826800400e5 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) * x +
                            0.1765360080e6 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) * z -
                            0.7840998000e5 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) * x * x +
                            0.4943188800e6 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) * z * z -
                            0.1925014410e6 * std::exp(-0.400e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * z +
                            0.3698838000e5 * std::exp(-0.600e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * x +
                            0.7397676000e5 * std::exp(-0.600e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * z -
                            0.16e2 * std::exp(-0.1200e3 * std::pow(x + 0.2e1 * z, 0.2e1)) * x -
                            0.32e2 * std::exp(-0.1200e3 * std::pow(x + 0.2e1 * z, 0.2e1)) * z -
                            0.6688400000e4 * std::exp(-0.800e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * x -
                            0.1337680000e5 * std::exp(-0.800e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * z +
                            0.556e3 * std::exp(-0.1000e3 * std::pow(x + 0.2e1 * z, 0.2e1)) * x +
                            0.1112e4 * std::exp(-0.1000e3 * std::pow(x + 0.2e1 * z, 0.2e1)) * z -
                            0.9625072050e5 * std::exp(-0.400e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * x +
                            0.8e1 * std::exp(-0.120e3 * x * x - 0.400e3 * x * z - 0.420e3 * z * z + z + 0.1e1) * x -
                            0.5763380040e5 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) * z +
                            0.1971823986e7 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) * z * z -
                            0.1950349995e5 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) * x +
                            0.7723580040e6 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) * x * x -
                            0.552024e6 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) * z * z -
                            0.138006e6 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) * x * x +
                            0.39792e5 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) * z * z +
                            0.9860004000e4 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) * x +
                            0.3318598800e5 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) * z +
                            0.8e1 * std::exp(-0.100e3 * x * x - 0.400e3 * x * z - 0.400e3 * z * z + z) * x +
                            0.16e2 * std::exp(-0.100e3 * x * x - 0.400e3 * x * z - 0.400e3 * z * z + z) * z +
                            0.1599287976e7 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) * x * z -
                            0.3447976000e5 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) * z +
                            0.1068266666e4 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) * x -
                            0.320e3 * std::exp(-0.120e3 * x * x - 0.400e3 * x * z - 0.420e3 * z * z + z + 0.1e1) * z * z +
                            0.4008e4 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) * x * x +
                            0.1930895010e5 * z * z * std::exp(-0.20e2 * x * x - 0.20e2 * z * z + z + 0.1e1) +
                            0.1930895010e5 * x * x * std::exp(-0.20e2 * x * x - 0.20e2 * z * z + z + 0.1e1) -
                            0.9654475050e3 * z * std::exp(-0.20e2 * x * x - 0.20e2 * z * z + z + 0.1e1) +
                            0.9751995000e4 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) * x * x +
                            0.3900798000e5 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) * z * z +
                            0.3881097000e6 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) * x * x +
                            0.1552438800e7 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) * z * z +
                            0.1552438800e7 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) * x * z +
                            0.3900798000e5 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) * x * z -
                            0.9097753500e4 * std::exp(-0.40e2 * x * x - 0.160e3 * x * z - 0.160e3 * z * z + z) -
                            0.640e3 * std::exp(-0.120e3 * x * x - 0.400e3 * x * z - 0.420e3 * z * z + z + 0.1e1) * x * z +
                            0.4200000000e1 * std::exp(-0.120e3 * x * x - 0.400e3 * x * z - 0.420e3 * z * z + z + 0.1e1) -
                            0.9533794112e3 * std::exp(-0.20e2 * x * x - 0.20e2 * z * z + z + 0.1e1) -
                            0.1036095000e4 * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) +
                            0.2253333334e2 * std::exp(-0.100e3 * x * x - 0.400e3 * x * z - 0.400e3 * z * z + z) +
                            0.1123231354e5 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) -
                            0.1863776536e5 * std::exp(-0.40e2 * x * x - 0.80e2 * x * z - 0.100e3 * z * z + z + 0.1e1) -
                            0.3960040000e5 * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) * x * x -
                            0.3696256000e6 * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) * z * z +
                            0.7636384800e6 * std::exp(-0.60e2 * x * x - 0.160e3 * x * z - 0.180e3 * z * z + z + 0.1e1) * x * z -
                            0.4400336000e6 * x * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) * z +
                            0.47840e5 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) * x * z +
                            0.47840e5 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) * z * z +
                            0.11960e5 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) * x * x -
                            0.6320160000e4 * std::exp(-0.80e2 * x * x - 0.240e3 * x * z - 0.260e3 * z * z + z + 0.1e1) * z +
                            0.9509415350e5 * std::exp(-0.200e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * x +
                            0.1901883070e6 * std::exp(-0.200e2 * std::pow(x + 0.2e1 * z, 0.2e1)) * z - 0.1191523129e5 * std::exp(z) -
                            0.552024e6 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) * x * z +
                            0.47712e5 * std::exp(-0.100e3 * x * x - 0.320e3 * x * z - 0.340e3 * z * z + z + 0.1e1) * x * z -
                            0.1723988000e5 * std::exp(-0.60e2 * x * x - 0.240e3 * x * z - 0.240e3 * z * z + z) * x -
                            0.1488766999e6 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) * x -
                            0.2977534000e6 * std::exp(-0.20e2 * x * x - 0.80e2 * x * z - 0.80e2 * z * z + z) * z +
                            0.2136533332e4 * std::exp(-0.80e2 * x * x - 0.320e3 * x * z - 0.320e3 * z * z + z) * z) *
                           std::pow(-0.4950000000e1 + std::exp(-0.200e2 * std::pow(x + 0.2e1 * z, 0.2e1)), -0.3e1) *
                           std::pow(-0.9950000000e1 + std::exp(-0.200e2 * std::pow(x + 0.2e1 * z, 0.2e1)), -0.2e1);
  ...
  class Gravity : public aspect::GravityModel::Interface<dim>
  {
    public:
      ...
      gravity_vector(const Point<dim> &pos) const
      {
        ...
        gravity[0] = (0.4000000000e1 * x * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z) /
                        (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) +
                      0.2000000000e0 * (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z) *
                        std::pow(-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)), -0.2e1) *
                        (-0.400e2 * x - 0.8000e2 * z) * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)) +
                      0.4000000000e1 * x * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z)) /
                     (0.9950000000e0 - 0.1000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)));
        gravity[1] = (-0.1333333333e1 * std::exp(z) +
                      0.4000000000e1 * z * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z) /
                        (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) -
                      (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z) /
                        (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) +
                      0.2000000000e0 * (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z) *
                        std::pow(-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)), -0.2e1) *
                        (-0.8000e2 * x - 0.160000e3 * z) * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)) -
                      0.1e1 + 0.4000000000e1 * z * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z) -
                      (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z)) /
                     (0.9950000000e0 - 0.1000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)));
  ...
  class RefFunction : public Function<dim>, public ::aspect::SimulatorAccess<dim>
  {
    public:
      ...
      vector_value(const Point<dim> &p, Vector<double> &values) const
      {
        ...
        values[2] = -(0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z) /
                      (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) +
                    0.1e1 - z;
  ...
  ConvergenceMeltPostprocessor<dim>::execute(TableHandler &statistics)
  {
    ...
    ComponentSelectFunction<dim> comp_u(std::pair<unsigned int, unsigned int>(0, dim), n_total_comp);
    ComponentSelectFunction<dim> comp_p_f(dim, n_total_comp);
    ComponentSelectFunction<dim> comp_p_c(dim + 1, n_total_comp);
    ComponentSelectFunction<dim> comp_u_f(std::pair<unsigned int, unsigned int>(dim + 2, dim + 2 + dim), n_total_comp);
    ...
    os << std::scientific << "ndofs= " << this->get_solution().size() << " u_L2= " << u_l2 << " p_L2= " << p_l2 << " p_f_L2= " << p_f_l2
       << " p_c_bar_L2= " << p_c_bar_l2 << " p_c_L2= " << p_c_l2 << " phi_L2= " << phi_l2 << " u_f_L2= " << u_f_l2;
        ...
        for (unsigned int q = 0; q < output.size(); ++q)
          {
            ...
            gradient[0] = 0.4000000000e1 * x * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z) /
                            (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) +
                          0.2000000000e0 * (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) *
                            std::exp(z) *
                            std::pow(-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1)), -0.2e1) *
                            (-0.400e2 * x - 0.8000e2 * z) * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1));
            gradient[1] = 0.4000000000e1 * z * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z) * std::exp(z) /
                            (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) -
                          (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) * std::exp(z) /
                            (-0.9900000000e0 + 0.2000000000e0 * std::exp(-0.200e2 * std::pow(x + 0.20e1 * z, 0.2e1))) +
                          0.2000000000e0 * (0.1e0 + 0.1e0 * std::exp(0.1e1 - 0.2000000000e2 * x * x - 0.2000000000e2 * z * z)) *
...
namespace aspect
{
  ASPECT_REGISTER_GRAVITY_MODEL(Gravity, "MyGravity", "")

  ASPECT_REGISTER_MATERIAL_MODEL(TestMeltMaterial, "test melt material", "")
  ASPECT_REGISTER_MESH_REFINEMENT_CRITERION(MeltVelocityRefinement, "melt velocity", "")
  ASPECT_REGISTER_MESH_REFINEMENT_CRITERION(PCRefinement, "pc", "")
