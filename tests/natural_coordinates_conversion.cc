...
f()
{
  ...
  // Box 2D
  {
    ...
    if (std::fabs(new_point_2d(0) - point_2d(0)) < 1e-8 && std::fabs(new_point_2d(1) - point_2d(1)) < 1e-8)
      std::cout << "Box 2D ok:                   point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
    else
      std::cout << "Box 2D failed:               point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
  }
  ...
  // Two merged boxes 2d
  {
    ...
    if (std::fabs(new_point_2d(0) - point_2d(0)) < 1e-8 && std::fabs(new_point_2d(1) - point_2d(1)) < 1e-8)
      std::cout << "Two merged boxes 2d ok:      point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
    else
      std::cout << "Two merged boxes 2d failed:  point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
  }
  ...
  // Chunk 2d
  {
    ...
    if (std::fabs(new_point_2d(0) - point_2d(0)) < 1e-8 && std::fabs(new_point_2d(1) - point_2d(1)) < 1e-8)
      std::cout << "Chunk 2D ok:                 point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
    else
      std::cout << "Chunk 2D failed:             point = " << point_2d << ", inter point = " << inter_point_2d[0] << ", "
                << inter_point_2d[1] << ", new_point = " << new_point_2d << std::endl;
  }
  ...
  // Box 3D
  {
    ...
    if (std::fabs(new_point_3d(0) - point_3d(0)) < 1e-8 && std::fabs(new_point_3d(1) - point_3d(1)) < 1e-8 &&
        std::fabs(new_point_3d(2) - point_3d(2)) < 1e-8)
      std::cout << "Box 3D ok:                   point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
    else
      std::cout << "Box 3D failed:               point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
  }
  ...
  // Two merged boxes 3d
  {
    ...
    if (std::fabs(new_point_3d(0) - point_3d(0)) < 1e-8 && std::fabs(new_point_3d(1) - point_3d(1)) < 1e-8 &&
        std::fabs(new_point_3d(2) - point_3d(2)) < 1e-8)
      std::cout << "Two merged boxes 3d ok:      point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
    else
      std::cout << "Two merged boxes 3d failed:  point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
  }
  ...
  // Chunk 3d
  {
    ...
    if (std::fabs(new_point_3d(0) - point_3d(0)) < 1e-8 && std::fabs(new_point_3d(1) - point_3d(1)) < 1e-8 &&
        std::fabs(new_point_3d(2) - point_3d(2)) < 1e-8)
      std::cout << "Chunk 3D ok:                 point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", new_point = " << new_point_3d << std::endl;
    else
      std::cout << "Chunk 3D failed:             point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", new_point = " << new_point_3d << std::endl;
  }
  ...
  // Ellipsoidal chunk 3d
  {
    ...
    if (std::fabs(new_point_3d(0) - point_3d(0)) < 1e-8 && std::fabs(new_point_3d(1) - point_3d(1)) < 1e-8 &&
        std::fabs(new_point_3d(2) - point_3d(2)) < 1e-8)
      std::cout << "Ellipsoidal 3d chunk ok:     point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
    else
      std::cout << "Ellipsoidal 3d chunk failed: point = " << point_3d << ", inter point = " << inter_point_3d[0] << ", "
                << inter_point_3d[1] << ", " << inter_point_3d[2] << ", new_point = " << new_point_3d << std::endl;
  }
