...
int f()
{
  ...
  command = ("cd output-diffusion_additional_checkpoint_4 ; "
             "(cat " ASPECT_SOURCE_DIR "/tests/diffusion_additional_checkpoint_4.prm "
             " ; "
  ...
  ret = system ("cd output-diffusion_additional_checkpoint_4 ; "
