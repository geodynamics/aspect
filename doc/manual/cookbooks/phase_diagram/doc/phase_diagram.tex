...
It is a simple way to check the implementation in a material model with visible outputs.% motivation
The idea lies in initiating a linear temperature variation along the x-axis in a box geometry, so as to view the two axes, x and y,  as pressure and temperature, respectively. % technique
...
A trick of assigning the values of density to the field of thermal capacity is used here [MIB: How is this done? can you be more explicit]. % trick
...
\par Moreover, I tested the a pyrolitic lookup table used in the Steinberg material model (Figure \ref{fig:phase_diagram_steinberg_density}).% steinberg model, todo fix reference
