...
{\it Description:} The minimum porosity that has to be present at the position of a particle for it to be considered a melt particle (in the sense that the melt_presence property is set to 1).
...
{\it Value:} compaction viscosity,permeability,p_c


{\it Default:} compaction viscosity,permeability,p_c
...
compaction viscosity|fluid viscosity|permeability|fluid density|fluid density gradient|p_c|is melt cell|darcy coefficient|darcy coefficient no cutoff


{\it Possible values:} A comma-separated list of any of compaction viscosity, fluid viscosity, permeability, fluid density, fluid density gradient, p_c, is melt cell, darcy coefficient, darcy coefficient no cutoff
\end{itemize}
