...
{\it Possible values:} [Selection Morency and Doin|Steinberger|composition reaction|latent heat|latent heat melt|multicomponent|simple|simple compressible|simpler ]
\end{itemize}
