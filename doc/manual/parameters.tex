...
{\it Description:} A relative tolerance with respect to the the residual of the first iteration, up to which the nonlinear Picard solver will iterate, before changing to the newton solver.
