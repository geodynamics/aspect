...
{\it Possible values:} Any one of zero topography
\end{itemize}
...
{\it Possible values:} Any one of first particle
...
{\it Possible values:} Any one of none, remove particles, remove and add particles, repartition
