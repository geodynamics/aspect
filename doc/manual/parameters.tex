...
{\it Value:} compaction viscosity,permeability,compaction pressure


{\it Default:} compaction viscosity,permeability,compaction pressure
...
compaction viscosity|fluid viscosity|permeability|fluid density|fluid density gradient|compaction pressure|is melt cell|darcy coefficient|darcy coefficient no cutoff


{\it Possible values:} A comma-separated list of any of compaction viscosity, fluid viscosity, permeability, fluid density, fluid density gradient, compaction pressure, is melt cell, darcy coefficient, darcy coefficient no cutoff
\end{itemize}
