...
{\it Possible values:} [Selection spherical constant|initial temperature|constant|box|Tan Gurnis ]
\end{itemize}
...
{\it Possible values:} [Selection sphere|box|spherical shell ]
\end{itemize}
...
{\it Possible values:} [Selection vertical|radial constant|radial earth-like|radial linear ]
\end{itemize}
...
{\it Possible values:} [Selection adiabatic|perturbed box|polar box|inclusion shape perturbation|mandelbox|function|spherical hexagonal perturbation|spherical gaussian perturbation|harmonic perturbation ]
\end{itemize}
...
{\it Possible values:} [Selection composition reaction|latent heat|Steinberger|table|simple|SolCx|SolKz|Inclusion|Tan Gurnis ]
\end{itemize}
...
{\it Possible values:} [MultipleSelection nonadiabatic temperature|composition|topography|thermal energy density|viscosity|density|temperature|velocity ]
...
{\it Possible values:} [MultipleSelection dynamic topography|velocity statistics for the table model|visualization|tracers|heat flux statistics for the table model|velocity statistics|composition statistics|depth average|DuretzEtAl error|temperature statistics|Tan Gurnis error|heat flux statistics|all ]
\end{itemize}
...
{\it Possible values:} [MultipleSelection dynamic topography|nonadiabatic temperature|artificial viscosity|error indicator|friction heating|strain rate|thermal expansivity|viscosity|Vs anomaly|Vp anomaly|density|viscosity ratio|specific heat|seismic vs|partition|melt fraction|thermodynamic phase|seismic vp|nonadiabatic pressure|all ]
...
{\it Possible values:} [MultipleSelection user request|steady state velocity|end time|end step|all ]
\end{itemize}
