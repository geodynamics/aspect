...
{\it Possible values:} Any one of Morency and Doin, Steinberger, averaging, composition reaction, depth dependent, diffusion dislocation, drucker prager, latent heat, latent heat melt, melt global, melt simple, multicomponent, nondimensional, simple, simple compressible, simpler, visco plastic, unspecified
\end{itemize}
...
{\it Possible values:} Any one of Morency and Doin, Steinberger, averaging, composition reaction, depth dependent, diffusion dislocation, drucker prager, latent heat, latent heat melt, melt global, melt simple, multicomponent, nondimensional, simple, simple compressible, simpler, visco plastic
