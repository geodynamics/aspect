...
{\it Possible values:} [MultipleSelection temperature statistics|heat flux statistics|visualization|velocity statistics|depth average|DuretzEtAl error|Tan Gurnis error|tracers|composition statistics|dynamic topography|all ]
\end{itemize}
...
{\it Possible values:} [MultipleSelection thermodynamic phase|friction heating|viscosity ratio|strain rate|nonadiabatic temperature|partition|artificial viscosity|nonadiabatic pressure|seismic vp|specific heat|density|viscosity|thermal expansivity|error indicator|Vs anomaly|Vp anomaly|seismic vs|melt fraction|dynamic topography|all ]
...
{\it Possible values:} [MultipleSelection end time|steady state velocity|user request|end step|all ]
\end{itemize}
