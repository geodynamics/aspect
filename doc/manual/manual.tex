...
downwellings (Figure~\ref{fig:pp}). This flow perturbs the top and bottom
surface of the mantle as well as the geoid.
...
the surface is balanced by excess topography. We use a consistent boundary flux 
method to calculate the radial stress at the surface \cite{ZGH93}. For the 
bottom surface we chose a convention that positive values are up (out)
...
surface and core mantle boundary.
