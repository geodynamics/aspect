...
\begin{table}[htb]
	...
	\end{tabular}
	\caption{\it Average runtimes for the Van Keken Benchmark with smoothed initial conditions.  All of these tests used different numbers of processors on one node on the BlueRidge cluster of ARC at Virginia Tech.}
