...
\begin{centering}
  ...
  {\Large
    ...
    ConvecTion}
  \\[.5cm]
  {\large Preview release, version 0.2\\
...
\item \textit{\dealii{}:}
  The current version of \aspect{} requires \dealii{} version 7.3.
  This version can be downloaded and installed from
  \url{https://code.google.com/p/dealii/downloads/list}. Note that the
  build system of \dealii{} has changed completely after release 7.3 and the
  instructions below will no longer work. For this release of \aspect{}, only
  \dealii{} version 7.3 is supported.
...
\item \textit{Configuring and compiling \dealii:} Now it is time to configure
  ...
  \href{http://www.dealii.org/7.3.0/readme.html}{installation
    instructions}.
