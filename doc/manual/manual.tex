...
subsection Material model
  ...
  subsection Simple model
    ...
    set Reference temperature         = 1 % \index[prmindex]{Reference temperature} \index[prmindexfull]{Material model!Simple model!Reference temperature} %
...
*** Timestep 1077:  t=0.499903 seconds
