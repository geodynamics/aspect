...
\subsection{A graphical user interface for \aspect{}}
...
user interface that builds upon an available program for deal.II. This GUI
...
The deal.II parameter-GUI program can be downloaded at \url{https://github.com/dealii/parameter_gui},
...
Example steps for installing the parameter-gui:
\begin{enumerate}
\item Download from \url{https://github.com/dealii/parameter_gui}.
...
In the appearing window you can change parameters as necessary, and then save the file as a new parameter file. This parameter file can then be used
...
to unexpected model behaviour or even unusable parameter files.
...
\hfill
\phantom.
\caption{\it The parameter GUI lists all available parameter options, and allows to change and save them into a new parameter file. Input fields know about the type of the variable and will display useful input fields to change them (e.g. drop-down menus, file dialogs, text fields).}
