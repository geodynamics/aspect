...
discussed in Section~\ref{sec:shell-simple-3d}. \aspect{}'s GPlates plugin
...
subsection Boundary velocity model
  subsection GPlates model
    ...
    set Time step = 3.3116e13 % \index[prmindex]{Time step} \index[prmindexfull]{Boundary velocity model!GPlates model!Time step} %
