...
\item Parameters for certain aspects of the numerical algorithm: These
  ...
  particular, this is the case for parameters
...
\texttt{source/simulator} directory.
...
\item \textit{Converting output into seismic velocities:} The predictions of
  ...
  straightforward if given a formula that expresses velocities in terms of the
