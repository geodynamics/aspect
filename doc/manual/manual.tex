...
boundary, or $\sigma \cdot \textbf{n} = 0$. Of course, with this boundary 
condition, we expect that in general there will be flow across the boundary.  
...
Lagrangian-Eulerian framework for handling motion of the mesh.  The ALE 
