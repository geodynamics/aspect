...
and we focus in what follows on the case II of this publication.
The domain is a 2D Cartesian box of size 2.24m$\times$1m. Gravity is Earth-like (9.81m/s$^2$).
...
0.75m, a viscosity $\eta_1=100$ Pa$\cdot$s and a density $\rho_1=100$kg/m$^3$. 
The middle layer (fluid 2) has a thickness 0.125m with $\rho_2=90$kg/$m^3$ and $\mu_2=1$Pa$\cdot$s.
The bottom layer (fluid 3) has a thickness 0.125m with $\rho_3=89$kg/m$^3$ and $\mu_3=1$Pa$\cdot$s.
The two interfaces between the layers are perturbed by a random noise of amplitude $\pm 0.001$m. Since fluid
...
The root mean square velocity (Figure~\ref{fig:polydiapirs_vrms}) shows two slopes in the early stages (t$<$50s)
...
\begin{figure}
    ...
    \caption{Density field at t=0,25,50,75s}
