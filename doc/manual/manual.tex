...
In their non-dimensional form derived by \cite{Deguen2013}, the equations for inner core convection in the approximation of no growth (equation 59 for the temperature) are
...
where $Ra$ is the Rayleigh number and $H$ is the 'source term', originated from the time-dependence of the reference temperature (secular cooling). 
