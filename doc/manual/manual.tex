...
\index[prmindex]{Material averaging for linear systems}
\index[prmindexfull]{Material model!Material averaging for linear systems}
...
anyway, and the averaging will not hurt very much either. In cases where the
solution features due to strongly varying viscosities or other parameters
dominate, we may then as well do the averaging per cell.
...
= \left(\frac 1N \sum_{i=1}^N \frac{1}{x_i}\right)^{-1}$, or (iv) replace the
values by the largest value over all quadrature points on this cell. Option
(v) is to project the values from the quadrature points to a bi- (in 2d) or
...
four operations, the values we get at the quadrature points are not all the
same here.
...
pressure, and
Table~\ref{tab:sinker-with-averaging-iteration-counts} shows the number
of outer GMRES iterations when solving the Stokes equations
\eqref{eq:stokes-1}--\eqref{eq:stokes-2}.%
...
\begin{table}[htb]
  ...
  \begin{tabular}{|c|ccccc|}
    \hline
    \# of global & no averaging & arithmetic & harmonic
    & pick & project \\
    refinement steps & & averaging &
    averaging & largest & to $Q_1$
    \\ \hline
    4          & 30+64   & 30+13      & 30+10    & 30+13 & 30+15 \\
    5          & 30+87   & 30+14      & 30+13    & 30+14 & 30+16 \\
    6          & 30+171  & 30+14      & 30+15    & 30+15 & 30+17 \\
    7          & 30+143  & 30+27      & 30+28    & 30+26 & 30+28 \\
    8          & 30+188  & 30+27      & 30+26    & 30+28 & 30+28 \\ \hline
  \end{tabular}
...
\begin{figure}[htb]
  \centering
  \begin{tabular}{ccccc}
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-7-none.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-7-arith.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-7-harmonic.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-7-largest.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-7-project.png}
    \\
    $[-45.2,45.2]$
    &
    $[-2.67,2.67]$
    ...
    \\
    \\
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-8-none.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-8-arith.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-8-harmonic.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-8-largest.png}
    &
    \includegraphics[width=0.17\textwidth]{cookbooks/sinker-with-averaging/sinker-8-project.png}
    \\
    $[-44.5,44.5]$
    &
    $[-5.18,5.18]$
  ...
  \caption{\it Visualization of the pressure field for the ``sinker''
    ...
    averaging, pick largest, project to $Q_1$. Top: 7 global refinement
    steps. Bottom: 8 global refinement steps. The minimal and maximal pressure
...
such cases because we do not know the exact solution.
