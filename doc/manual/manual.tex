...
\lstinputlisting[language=prmfile]{cookbooks/kinematically_driven_subduction_2d_case1/Case1_compositions.prm.out}
...
\lstinputlisting[language=prmfile]{cookbooks/kinematically_driven_subduction_2d_case1/Case1_materialmodel.prm.out}
...
\lstinputlisting[language=prmfile]{cookbooks/kinematically_driven_subduction_2d_case1/Case1_velocity.prm.out}
...
\lstinputlisting[language=prmfile]{cookbooks/kinematically_driven_subduction_2d_case1/Case1_meshrefinement.prm.out}
...
\lstinputlisting[language=prmfile]{cookbooks/kinematically_driven_subduction_2d_case1/Case1_postprocessing.prm.out}
...
\begin{figure}
    ...
    \caption{\it Case 1 viscosity snapshots at 0, 8 and 15 My.}
