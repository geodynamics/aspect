...
\begin{figure}
	...
	\caption{\it Van Keken benchmark with smoothed initial conditions for the compositional field using 7 global refinements for different smoothing parameters.  Number of time steps is shown on the x-axis, while root mean square velocity is shown on the y-axis.}
	\label{fig:vk-6}
\end{figure}
