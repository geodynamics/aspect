...
with a globally five times refined mesh 4.914 and with the mesh generated using
the procedure above we get 4.895 with the four digits printed on the screen
(the statistics file gives a more exact value, 4.89488768).
The accepted value from Blankenbach is $4.884409\pm 0.00001$. In other words, our
