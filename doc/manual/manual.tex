...
the surface pressure normalisation is used. The boundary conditions that are used are simply 
...
\subsubsection{The annulus benchmark}
...
\caption{Pressure, density and velocity fields for $k=0,1,2,3$.}
