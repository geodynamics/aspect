...
\footnote{The outer iterations are only part of the problem. As discussed in
  ...
  elliptic block and from 3.8 to 1.5 for the Schur complement. The end effect
  is that the total run time for 8 global refinement steps is reduced from
  5250s to 358s for this particular example.}
...
\begin{table}
  ...
  \begin{tabular}{|c|cccc|}
    ...
    averaging & pick largest
    \\ \hline
    4          & 30+64   & 30+13      & 30+10    & 30+13 \\
    5          & 30+87   & 30+14      & 30+13    & 30+14 \\
    6          & 30+171  & 30+14      & 30+15    & 30+15 \\
    7          & 30+143  & 30+27      & 30+28    & 30+26 \\
    8          & 30+188  & 30+27      & 30+26    & 30+28 \\ \hline
  \end{tabular}
