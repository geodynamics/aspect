...
\begin{align}
  ...
  \eta_\text{plastic}(\dot\epsilon) &= \eta^\asterisk + \frac{\sigma_y}{\sqrt(\dot\epsilon:\dot\epsilon)}
  \label{eq:tosi-benchmark-plast-visc}
\end{align}
where $\eta^\asterisk$ is the constant effective viscosity at high stresses and $\sigma_y$ the yield stress.
...
\begin{equation}
  \eta_{T,\epsilon,z) = 2 \left(\frac{1}{\eta_\text{linear}}+\frac{1}{\eta_\text{plastic}}\right)^{-1}  
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.33\textwidth]{cookbooks/benchmarks/tosi/Case1_6_T.png}
    \includegraphics[width=0.33\textwidth]{cookbooks/benchmarks/tosi/Case1_6_visc.png}
    \includegraphics[width=0.33\textwidth]{cookbooks/benchmarks/tosi/Case1_6_vel.png}
  \end{center}
