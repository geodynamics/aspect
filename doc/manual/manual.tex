...
do not lead to numerical problems in our computation (see Section~\ref{sec:sec:sinker-with-averaging}), 
...
As the reference profile also contains data for the compressibility, this model is compressible
(unless the compressibility is zero everywhere) without the need to specify this explicitly. 
