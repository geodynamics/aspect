...
\lstinputlisting[frame=single,language=prmfile]{cookbooks/benchmarks/solcx.prm.out}
...
\lstinputlisting[frame=single,language=prmfile]{cookbooks/benchmarks/solkz.prm.out}
