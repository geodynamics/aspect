...
values by the largest value over all quadrature points on this cell. We do this
operation for all quantities that the material model computes, i.e., in
particular, the viscosity, the density, the compressibility, and the various
...
For the various different cases of averaging, and for different levels of mesh
refinement, Fig.~\ref{fig:sinker-with-averaging-iteration-pressure} shows
...
that not only avoids the pressure over- and undershots, but is also
significantly faster to compute the total run time for 8 global refinement steps is
reduced from 5,250s for no averaging to 358s for harmonic averaging.

\begin{table}
  \center
  \begin{tabular}{|c|cccc|}
    \hline
    \# global refinement steps & no averaging & arithmetic averaging & harmonic
    averaging & pick largest & project to $Q_1$
    \\ \hline
    4          & 30+64   & 30+13      & 30+10    & 30+13 & 30+238 \\
    5          & 30+87   & 30+14      & 30+13    & 30+14 & 30+406 \\
    6          & 30+171  & 30+14      & 30+15    & 30+15 & 30+1068 \\
    7          & 30+143  & 30+27      & 30+28    & 30+26 & ?? \\
    8          & 30+188  & 30+27      & 30+26    & 30+28 & 30+2382 \\ \hline
  \end{tabular}
