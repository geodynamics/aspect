...
\caption{\it Compositional field after 5e6 years of extension. The black line marks the 550 $^{o}C$ isotherm.} 
...
\caption{\it Strain rate($s^{-1}$) after 10e6 years of extension. The black line marks the 550 $^{o}C$ isotherm. The numerical resolution (1 km) is double that of the previous model.} 
