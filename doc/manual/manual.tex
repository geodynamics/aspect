...
Cite the  most recent release of ASPECT (v1.5.0) as:
\begin{lstlisting}[frame=single,language=tex]
...
Citation information for recent and past versions of ASPECT can also be found at: \url{geodynamics.org/abc}.
