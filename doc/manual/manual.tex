...
while the weak form (with test function $\varphi$) becomes:
\[
a(T,\varphi) =
...
For streamline upwind/Petrov-Galerkin (SUPG) (see for example \cite{JohnKnobloch2006,dealiistep-63}), we amend the weak form with a cell-wise
defined weak form
\[
...
\]
$d$ is the polynomial degree (typically 2) and
$
