...
(see \texttt{tests/spectral-comparison/} for figure and details).
...
\label{sec:cookbooks-polydiapirism}

We consider a three-layer viscous Rayleigh-Taylor instability proposed by Weinberg and Schmeling \cite{wesc92} 
and we focus in what follows on the case II of this publlication.
The domain is a 2D Cartesian box of size $2.24\times 1$. Gravity is Earth-like.
Boundary conditions are free-slip on the sides and top and no-slip at the bottom.
All three layers are initially horizontal. The top layer (fluid 1) has a thickness of 0.75, a viscosity $\eta_1=100$ and a density $\rho_1=100$. The middle layer (fluid 2) has a thickness 0.125 with $\rho_2=90$ and $\mu_2=1$.
The bottom layer (fluid 3) has a thickness 0.125 with $\rho_3=89$ and $\mu_3=1$.
The two interfaces between the layers are perturbed by a random noise of amplitude $\pm 0.001$. Since fluid
3 is lighter than fluid 2 and fluid 2 is lighter than fluid 1, both interfaces are unstable.
We observe that interface 2-3 deforms first, produces domes which are subsequently incorporated in the domes 
being generated at the interface 1-2.
The root mean square velocity shows two slopes corresponding to the two different growth rates of the interfaces, 
as explained by linear stability analysis \cite{ramb81}.
...
\begin{figure}
    ...
    \caption{Density field at t=0,25,50,75}
...
\begin{figure}
    ...
    \caption{Root mean square velocity as a function of time}
    \label{fig:polydiapirs_density}
\end{figure}
