...
\url{doc/doxygen/classaspect_1_1GeometryModel_1_1Interface.html}.  The purpose
...
\end{lstlisting}
The kind of information these functions need to provide is
discussed in the documentation of this interface class at
\url{doc/doxygen/classaspect_1_1GravityModel_1_1Interface.html} but is likely
already obvious. The purpose
of the last two functions has been discussed in the general overview of
plugins above.
...
discussed in the documentation of this interface class at
\url{doc/doxygen/classaspect_1_1BoundaryTemperature_1_1Interface.html}. The purpose
of the last two functions has been discussed in the general overview of
plugins above.
