...
\begin{align}
  ...
  \\
  &\quad
  - \frac{\phi }{\rho_f} \mathbf v_f \cdot \nabla\rho_f 
  - \frac{1 - \phi }{\rho_s} \mathbf v_s \cdot \nabla\rho_s
  & \qquad
  & \textrm{in $\Omega$},
  \notag
  \\
