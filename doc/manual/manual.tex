...
hydrostatic pressure and dynamic pressure (see
...
One can reformulate equation \eqref{eq:stokes-1} somewhat. To this end, let us
...
$$-\nabla \cdot 2\eta
 ...
 where $p_d=(p+\rho_0 \varphi)$, and $\phi$ is the
