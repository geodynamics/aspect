...
% and for gnuplot
\usepackage{listings}
\lstset{language=C++,basicstyle=\small\ttfamily,columns=fullflexible,keepspaces=true}
...
\lstinputlisting[frame=single,language=prmfile,escapeinside={\%}{\%}]{cookbooks/benchmarks/inclusion.prm.out}
