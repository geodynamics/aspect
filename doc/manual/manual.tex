...
$|{\bm g}|=10\text{m}/\text{s}^2$. Boundary conditions are free slip on all sides. 
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{cookbooks/benchmarks/sinking_block/dens_vel}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{cookbooks/benchmarks/sinking_block/plot.pdf}
