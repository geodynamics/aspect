...
\item Download and install the parallel \dealii{} binary
%Current latest deal.ii version is 8.2.1.
{\footnotesize
\begin{verbatim}
%  open \
https://github.com/dealii/dealii/releases/download/v8.2.1/dealii-8.2.1-parallel-bundle.dmg
\end{verbatim}
}
...
============ Configuring ASPECT ====================
====================================================
-- Found deal.II version 8.2.1 at '/Applications/deal.II.app/Contents/Resources/lib/cmake/deal.II'
-- Using PETSc = 'OFF'
-- Added 184 tests
====================================================
...
...
-rwxr-xr-x  1 matsui  staff  19131292 May  7 15:02 aspect
\end{verbatim}
}
...
To start \aspect{} using MPI for parallelization:
{\footnotesize
\begin{verbatim}
mpirun -np <# of processes> $HOME/src/aspect/build_deal.ii.app/aspect <parameter file>
\end{verbatim}}
