...
&lsquo;chunk&rsquo;: A geometry which can be described as a chunk of a spherical shell, bounded by lines of longitude, latitude and radius. The minimum and maximum longitude, latitude (if in 3d) and depth of the chunk is set in the parameter file. The chunk geometry labels its 2*dim sides as follows: &lsquo;&lsquo;west&rsquo;&rsquo; and &lsquo;&lsquo;east&rsquo;&rsquo;: minimum and maximum longitude, &lsquo;&lsquo;south&rsquo;&rsquo; and &lsquo;&lsquo;north&rsquo;&rsquo;: minimum and maximum latitude, &lsquo;&lsquo;inner&rsquo;&rsquo; and &lsquo;&lsquo;outer&rsquo;&rsquo;: minimum and maximum radii.
...
&lsquo;chunk with lithosphere boundary indicators&rsquo;: A geometry which can be described as a chunk of a spherical shell, bounded by lines of longitude, latitude and radius. The side boundaries have two boundary indicators, so the user can prescribe different boundary conditions on these boundaries. The minimum and maximum longitude, (latitude) and depth of the chunk are set in the parameter file. The chunk geometry labels its 2*dim+2*(dim-1) sides as follows: &lsquo;&lsquo;lower west&rsquo;&rsquo; and &lsquo;&lsquo;lower east&rsquo;&rsquo;: minimum and maximum longitude of the lower part of the east and west side boundaries, &lsquo;&lsquo;upper west and upper east&rsquo;&rsquo;: minimum and maximum longitude of the upper part of the east and west side boundaries, &lsquo;&lsquo;lower south&rsquo;&rsquo; and &lsquo;&lsquo;lower north&rsquo;&rsquo;: minimum and maximum latitude of the lower part of the south and north side boundaries, &lsquo;&lsquo;upper south&rsquo;&rsquo; and &lsquo;&lsquo;upper north&rsquo;&rsquo;: minimum and maximum latitude of the upper part of the south and north side boundaries,
...
&lsquo;sphere&rsquo;: A geometry model for a sphere with a user specified radius. This geometry has only a single boundary, so the only valid boundary indicator to specify in input files is &lsquo;&lsquo;0&rsquo;&rsquo;. It can also be referenced by the symbolic name &lsquo;&lsquo;surface&rsquo;&rsquo; in input files.
