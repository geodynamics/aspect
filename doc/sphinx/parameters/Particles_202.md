...
::::{dropdown} __Parameter:__ {ref}`Addition point density function granularity<parameters:Particles_202/Addition_20point_20density_20function_20granularity>`
:name: parameters:Particles_202/Addition_20point_20density_20function_20granularity
**Default value:** 6
...
::::{dropdown} __Parameter:__ {ref}`Allow cells without particles<parameters:Particles_202/Allow_20cells_20without_20particles>`
:name: parameters:Particles_202/Allow_20cells_20without_20particles
**Default value:** false
...
::::{dropdown} __Parameter:__ {ref}`Bandwidth<parameters:Particles_202/Bandwidth>`
...
::::{dropdown} __Parameter:__ {ref}`Interpolation scheme<parameters:Particles_202/Interpolation_20scheme>`
...
::::{dropdown} __Parameter:__ {ref}`List of particle properties<parameters:Particles_202/List_20of_20particle_20properties>`
...
::::{dropdown} __Parameter:__ {ref}`Load balancing strategy<parameters:Particles_202/Load_20balancing_20strategy>`
:name: parameters:Particles_202/Load_20balancing_20strategy
...
::::{dropdown} __Parameter:__ {ref}`Minimum particles per cell<parameters:Particles_202/Minimum_20particles_20per_20cell>`
:name: parameters:Particles_202/Minimum_20particles_20per_20cell
**Default value:** 0
...
::::{dropdown} __Parameter:__ {ref}`Particle addition algorithm<parameters:Particles_202/Particle_20addition_20algorithm>`
:name: parameters:Particles_202/Particle_20addition_20algorithm
...
:name: parameters:Particles_202/Particle_20generator_20name
...
::::{dropdown} __Parameter:__ {ref}`Particle removal algorithm<parameters:Particles_202/Particle_20removal_20algorithm>`
:name: parameters:Particles_202/Particle_20removal_20algorithm
**Default value:** random
...
::::{dropdown} __Parameter:__ {ref}`Particle weight<parameters:Particles_202/Particle_20weight>`
:name: parameters:Particles_202/Particle_20weight
**Default value:** 10
...
::::{dropdown} __Parameter:__ {ref}`Number of samples<parameters:Particles_202/CPO_20Bingham_20Average/Number_20of_20samples>`
:name: parameters:Particles_202/CPO_20Bingham_20Average/Number_20of_20samples
**Default value:** 0
...
::::{dropdown} __Parameter:__ {ref}`Random number seed<parameters:Particles_202/CPO_20Bingham_20Average/Random_20number_20seed>`
:name: parameters:Particles_202/CPO_20Bingham_20Average/Random_20number_20seed
**Default value:** 1
...
::::{dropdown} __Parameter:__ {ref}`List of products<parameters:Particles_202/Composition_20reaction/List_20of_20products>`
:name: parameters:Particles_202/Composition_20reaction/List_20of_20products
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`List of reactants<parameters:Particles_202/Composition_20reaction/List_20of_20reactants>`
:name: parameters:Particles_202/Composition_20reaction/List_20of_20reactants
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`List of reaction times<parameters:Particles_202/Composition_20reaction/List_20of_20reaction_20times>`
:name: parameters:Particles_202/Composition_20reaction/List_20of_20reaction_20times
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`Coordinate system<parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Coordinate_20system>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Coordinate_20system
...
::::{dropdown} __Parameter:__ {ref}`Function constants<parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Function_20constants>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Function_20constants
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`Function expression<parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Function_20expression>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Function_20expression
**Default value:** 0
...
::::{dropdown} __Parameter:__ {ref}`Variable names<parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Variable_20names>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20area_20function/Variable_20names
**Default value:** x,y,t
...
::::{dropdown} __Parameter:__ {ref}`Function constants<parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Function_20constants>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Function_20constants
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`Function expression<parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Function_20expression>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Function_20expression
**Default value:** 1.
...
::::{dropdown} __Parameter:__ {ref}`Variable names<parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Variable_20names>`
:name: parameters:Particles_202/Composition_20reaction/Reaction_20rate_20function/Variable_20names
...
:name: parameters:Particles_202/Crust_20and_20lithosphere_20formation/Lithosphere_20thickness
**Default value:** 63000
...
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/CPO_20derivatives_20algorithm
...
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Number_20of_20grains_20per_20particle
**Default value:** 50
...
::::{dropdown} __Parameter:__ {ref}`Property advection max iterations<parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20max_20iterations>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20max_20iterations
**Default value:** 100
...
::::{dropdown} __Parameter:__ {ref}`Property advection method<parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20method>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20method
...
::::{dropdown} __Parameter:__ {ref}`Property advection tolerance<parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20tolerance>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Property_20advection_20tolerance
**Default value:** 1e-10
...
::::{dropdown} __Parameter:__ {ref}`Random number seed<parameters:Particles_202/Crystal_20Preferred_20Orientation/Random_20number_20seed>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Random_20number_20seed
**Default value:** 1
...
::::{dropdown} __Parameter:__ {ref}`Exponents p<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Exponents_20p>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Exponents_20p
**Default value:** 1.5
...
::::{dropdown} __Parameter:__ {ref}`Mobility<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Mobility>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Mobility
**Default value:** 50
...
::::{dropdown} __Parameter:__ {ref}`Nucleation efficiency<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Nucleation_20efficiency>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Nucleation_20efficiency
**Default value:** 5
...
::::{dropdown} __Parameter:__ {ref}`Stress exponents<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Stress_20exponents>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Stress_20exponents
**Default value:** 3.5
...
::::{dropdown} __Parameter:__ {ref}`Threshold GBS<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Threshold_20GBS>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Threshold_20GBS
**Default value:** 0.3
...
::::{dropdown} __Parameter:__ {ref}`Volume fractions minerals<parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Volume_20fractions_20minerals>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/D_2dRex_202004/Volume_20fractions_20minerals
...
::::{dropdown} __Parameter:__ {ref}`CPX RRSS<parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/CPX_20RRSS>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/CPX_20RRSS
...
::::{dropdown} __Parameter:__ {ref}`Minerals<parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Minerals>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Minerals
...
::::{dropdown} __Parameter:__ {ref}`Model name<parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Model_20name>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Model_20name
...
::::{dropdown} __Parameter:__ {ref}`OlivineD RRSS<parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/OlivineD_20RRSS>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/OlivineD_20RRSS
...
::::{dropdown} __Parameter:__ {ref}`Volume fractions minerals<parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Volume_20fractions_20minerals>`
:name: parameters:Particles_202/Crystal_20Preferred_20Orientation/Initial_20grains/Volume_20fractions_20minerals
...
::::{dropdown} __Parameter:__ {ref}`Particle stress value weight<parameters:Particles_202/Elastic_20stress/Particle_20stress_20value_20weight>`
:name: parameters:Particles_202/Elastic_20stress/Particle_20stress_20value_20weight
**Default value:** 1.0
...
::::{dropdown} __Parameter:__ {ref}`Function expression<parameters:Particles_202/Function/Function_20expression>`
:name: parameters:Particles_202/Function/Function_20expression
**Default value:** 0
...
::::{dropdown} __Parameter:__ {ref}`Number of components<parameters:Particles_202/Function/Number_20of_20components>`
:name: parameters:Particles_202/Function/Number_20of_20components
**Default value:** 1
...
::::{dropdown} __Parameter:__ {ref}`Variable names<parameters:Particles_202/Function/Variable_20names>`
:name: parameters:Particles_202/Function/Variable_20names
**Default value:** x,y,t
...
::::{dropdown} __Parameter:__ {ref}`Data directory<parameters:Particles_202/Generator/Ascii_20file/Data_20directory>`
:name: parameters:Particles_202/Generator/Ascii_20file/Data_20directory
...
::::{dropdown} __Parameter:__ {ref}`Data file name<parameters:Particles_202/Generator/Ascii_20file/Data_20file_20name>`
:name: parameters:Particles_202/Generator/Ascii_20file/Data_20file_20name
...
::::{dropdown} __Parameter:__ {ref}`Function constants<parameters:Particles_202/Generator/Probability_20density_20function/Function_20constants>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Function_20constants
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`Function expression<parameters:Particles_202/Generator/Probability_20density_20function/Function_20expression>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Function_20expression
**Default value:** 1.0
...
::::{dropdown} __Parameter:__ {ref}`Number of particles<parameters:Particles_202/Generator/Probability_20density_20function/Number_20of_20particles>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Number_20of_20particles
**Default value:** 1000
...
::::{dropdown} __Parameter:__ {ref}`Random cell selection<parameters:Particles_202/Generator/Probability_20density_20function/Random_20cell_20selection>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Random_20cell_20selection
**Default value:** true
...
::::{dropdown} __Parameter:__ {ref}`Random number seed<parameters:Particles_202/Generator/Probability_20density_20function/Random_20number_20seed>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Random_20number_20seed
**Default value:** 5432
...
::::{dropdown} __Parameter:__ {ref}`Variable names<parameters:Particles_202/Generator/Probability_20density_20function/Variable_20names>`
:name: parameters:Particles_202/Generator/Probability_20density_20function/Variable_20names
**Default value:** x,y,t
...
::::{dropdown} __Parameter:__ {ref}`Number of particles<parameters:Particles_202/Generator/Random_20uniform/Number_20of_20particles>`
:name: parameters:Particles_202/Generator/Random_20uniform/Number_20of_20particles
**Default value:** 1000
...
::::{dropdown} __Parameter:__ {ref}`Random cell selection<parameters:Particles_202/Generator/Random_20uniform/Random_20cell_20selection>`
:name: parameters:Particles_202/Generator/Random_20uniform/Random_20cell_20selection
**Default value:** true
...
::::{dropdown} __Parameter:__ {ref}`Random number seed<parameters:Particles_202/Generator/Random_20uniform/Random_20number_20seed>`
:name: parameters:Particles_202/Generator/Random_20uniform/Random_20number_20seed
**Default value:** 5432
...
::::{dropdown} __Parameter:__ {ref}`Number of particles per cell per direction<parameters:Particles_202/Generator/Reference_20cell/Number_20of_20particles_20per_20cell_20per_20direction>`
:name: parameters:Particles_202/Generator/Reference_20cell/Number_20of_20particles_20per_20cell_20per_20direction
**Default value:** 2
...
::::{dropdown} __Parameter:__ {ref}`Maximum x<parameters:Particles_202/Generator/Uniform_20box/Maximum_20x>`
:name: parameters:Particles_202/Generator/Uniform_20box/Maximum_20x
**Default value:** 1.
...
::::{dropdown} __Parameter:__ {ref}`Maximum y<parameters:Particles_202/Generator/Uniform_20box/Maximum_20y>`
:name: parameters:Particles_202/Generator/Uniform_20box/Maximum_20y
**Default value:** 1.
...
::::{dropdown} __Parameter:__ {ref}`Maximum z<parameters:Particles_202/Generator/Uniform_20box/Maximum_20z>`
:name: parameters:Particles_202/Generator/Uniform_20box/Maximum_20z
**Default value:** 1.
...
::::{dropdown} __Parameter:__ {ref}`Minimum x<parameters:Particles_202/Generator/Uniform_20box/Minimum_20x>`
:name: parameters:Particles_202/Generator/Uniform_20box/Minimum_20x
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Minimum y<parameters:Particles_202/Generator/Uniform_20box/Minimum_20y>`
:name: parameters:Particles_202/Generator/Uniform_20box/Minimum_20y
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Minimum z<parameters:Particles_202/Generator/Uniform_20box/Minimum_20z>`
:name: parameters:Particles_202/Generator/Uniform_20box/Minimum_20z
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Number of particles<parameters:Particles_202/Generator/Uniform_20box/Number_20of_20particles>`
:name: parameters:Particles_202/Generator/Uniform_20box/Number_20of_20particles
**Default value:** 1000
...
::::{dropdown} __Parameter:__ {ref}`Center x<parameters:Particles_202/Generator/Uniform_20radial/Center_20x>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Center_20x
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Center y<parameters:Particles_202/Generator/Uniform_20radial/Center_20y>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Center_20y
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Center z<parameters:Particles_202/Generator/Uniform_20radial/Center_20z>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Center_20z
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Maximum latitude<parameters:Particles_202/Generator/Uniform_20radial/Maximum_20latitude>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Maximum_20latitude
**Default value:** 180.
...
::::{dropdown} __Parameter:__ {ref}`Maximum longitude<parameters:Particles_202/Generator/Uniform_20radial/Maximum_20longitude>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Maximum_20longitude
**Default value:** 360.
...
::::{dropdown} __Parameter:__ {ref}`Maximum radius<parameters:Particles_202/Generator/Uniform_20radial/Maximum_20radius>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Maximum_20radius
**Default value:** 1.
...
::::{dropdown} __Parameter:__ {ref}`Minimum latitude<parameters:Particles_202/Generator/Uniform_20radial/Minimum_20latitude>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Minimum_20latitude
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Minimum longitude<parameters:Particles_202/Generator/Uniform_20radial/Minimum_20longitude>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Minimum_20longitude
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Minimum radius<parameters:Particles_202/Generator/Uniform_20radial/Minimum_20radius>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Minimum_20radius
**Default value:** 0.
...
::::{dropdown} __Parameter:__ {ref}`Number of particles<parameters:Particles_202/Generator/Uniform_20radial/Number_20of_20particles>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Number_20of_20particles
**Default value:** 1000
...
::::{dropdown} __Parameter:__ {ref}`Radial layers<parameters:Particles_202/Generator/Uniform_20radial/Radial_20layers>`
:name: parameters:Particles_202/Generator/Uniform_20radial/Radial_20layers
**Default value:** 1
...
::::{dropdown} __Parameter:__ {ref}`Higher order accurate in time<parameters:Particles_202/Integrator/RK2/Higher_20order_20accurate_20in_20time>`
:name: parameters:Particles_202/Integrator/RK2/Higher_20order_20accurate_20in_20time
**Default value:** true
...
(parameters:Particles_202/Interpolator/Linear_20least_20squares)=
## **Subsection:** Particles 2 / Interpolator / Linear least squares
::::{dropdown} __Parameter:__ {ref}`Use boundary extrapolation<parameters:Particles_202/Interpolator/Linear_20least_20squares/Use_20boundary_20extrapolation>`
:name: parameters:Particles_202/Interpolator/Linear_20least_20squares/Use_20boundary_20extrapolation
**Default value:** false
...
::::{dropdown} __Parameter:__ {ref}`Use linear least squares limiter<parameters:Particles_202/Interpolator/Linear_20least_20squares/Use_20linear_20least_20squares_20limiter>`
:name: parameters:Particles_202/Interpolator/Linear_20least_20squares/Use_20linear_20least_20squares_20limiter
**Default value:** true
...
::::{dropdown} __Parameter:__ {ref}`Use boundary extrapolation<parameters:Particles_202/Interpolator/Quadratic_20least_20squares/Use_20boundary_20extrapolation>`
:name: parameters:Particles_202/Interpolator/Quadratic_20least_20squares/Use_20boundary_20extrapolation
**Default value:** false
...
::::{dropdown} __Parameter:__ {ref}`Use quadratic least squares limiter<parameters:Particles_202/Interpolator/Quadratic_20least_20squares/Use_20quadratic_20least_20squares_20limiter>`
:name: parameters:Particles_202/Interpolator/Quadratic_20least_20squares/Use_20quadratic_20least_20squares_20limiter
**Default value:** true
...
**Documentation:** Options: triclinic, orthorhombic. This determines which symmetry operators are used to project rotations into the fundamental zone of the respective symmetry group. triclinic: equates to no symmetry or the identity as the only symmetry operator. In this case a standard average for rotations represented by quaternions is used; see Markley et al. 2007. orthorhombic: symmetry group with 4 symmetry elements. In this case an experimental algorithm to take into account crystal symmetry is used.
::::

(parameters:Particles_202/Melt_20particle)=
## **Subsection:** Particles 2 / Melt particle
::::{dropdown} __Parameter:__ {ref}`Threshold for melt presence<parameters:Particles_202/Melt_20particle/Threshold_20for_20melt_20presence>`
:name: parameters:Particles_202/Melt_20particle/Threshold_20for_20melt_20presence
**Default value:** 1e-3
