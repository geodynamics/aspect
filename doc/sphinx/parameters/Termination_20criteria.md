...
::::{dropdown} __Parameter:__ {ref}`Checkpoint on termination<parameters:Termination_20criteria/Checkpoint_20on_20termination>`
:name: parameters:Termination_20criteria/Checkpoint_20on_20termination
**Default value:** false
...
::::{dropdown} __Parameter:__ {ref}`End step<parameters:Termination_20criteria/End_20step>`
:name: parameters:Termination_20criteria/End_20step
**Default value:** 100
...
::::{dropdown} __Parameter:__ {ref}`Termination criteria<parameters:Termination_20criteria/Termination_20criteria>`
...
::::{dropdown} __Parameter:__ {ref}`Wall time<parameters:Termination_20criteria/Wall_20time>`
:name: parameters:Termination_20criteria/Wall_20time
**Default value:** 24.

**Pattern:** [Double 0...MAX_DOUBLE (inclusive)]

**Documentation:** The wall time of the simulation. Unit: \si{\hour}.
::::

(parameters:Termination_20criteria/Steady_20state_20heat_20flux)=
## **Subsection:** Termination criteria / Steady state heat flux
::::{dropdown} __Parameter:__ {ref}`Boundary indicators<parameters:Termination_20criteria/Steady_20state_20heat_20flux/Boundary_20indicators>`
:name: parameters:Termination_20criteria/Steady_20state_20heat_20flux/Boundary_20indicators
**Default value:**
...
::::{dropdown} __Parameter:__ {ref}`Maximum relative deviation<parameters:Termination_20criteria/Steady_20state_20heat_20flux/Maximum_20relative_20deviation>`
:name: parameters:Termination_20criteria/Steady_20state_20heat_20flux/Maximum_20relative_20deviation
**Default value:** 0.05
...
::::{dropdown} __Parameter:__ {ref}`Time in steady state<parameters:Termination_20criteria/Steady_20state_20heat_20flux/Time_20in_20steady_20state>`
:name: parameters:Termination_20criteria/Steady_20state_20heat_20flux/Time_20in_20steady_20state
**Default value:** 1e7

**Pattern:** [Double 0...MAX_DOUBLE (inclusive)]

**Documentation:** The minimum length of simulation time that the system should be in steady state before termination. Note that if the time step size is similar to or larger than this value, the termination criterion will only have very few (in the most extreme case, just two) heat flux values to check. To ensure that a larger number of time steps are included in the check for steady state, this value should be much larger than the time step size. Units: \si{\year} if the &rsquo;Use years instead of seconds&rsquo; parameter is set; \si{\second} otherwise.
::::

(parameters:Termination_20criteria/Steady_20state_20temperature)=
## **Subsection:** Termination criteria / Steady state temperature
::::{dropdown} __Parameter:__ {ref}`Maximum relative deviation<parameters:Termination_20criteria/Steady_20state_20temperature/Maximum_20relative_20deviation>`
:name: parameters:Termination_20criteria/Steady_20state_20temperature/Maximum_20relative_20deviation
**Default value:** 0.05
...
::::{dropdown} __Parameter:__ {ref}`Time in steady state<parameters:Termination_20criteria/Steady_20state_20temperature/Time_20in_20steady_20state>`
:name: parameters:Termination_20criteria/Steady_20state_20temperature/Time_20in_20steady_20state
**Default value:** 1e7

**Pattern:** [Double 0...MAX_DOUBLE (inclusive)]

**Documentation:** The minimum length of simulation time that the system should be in steady state before termination.Units: \si{\year} if the &rsquo;Use years instead of seconds&rsquo; parameter is set; \si{\second} otherwise.
::::

(parameters:Termination_20criteria/Steady_20state_20velocity)=
## **Subsection:** Termination criteria / Steady state velocity
::::{dropdown} __Parameter:__ {ref}`Maximum relative deviation<parameters:Termination_20criteria/Steady_20state_20velocity/Maximum_20relative_20deviation>`
:name: parameters:Termination_20criteria/Steady_20state_20velocity/Maximum_20relative_20deviation
**Default value:** 0.05
...
::::{dropdown} __Parameter:__ {ref}`Time in steady state<parameters:Termination_20criteria/Steady_20state_20velocity/Time_20in_20steady_20state>`
:name: parameters:Termination_20criteria/Steady_20state_20velocity/Time_20in_20steady_20state
**Default value:** 1e7
...
::::{dropdown} __Parameter:__ {ref}`File name<parameters:Termination_20criteria/User_20request/File_20name>`
:name: parameters:Termination_20criteria/User_20request/File_20name
