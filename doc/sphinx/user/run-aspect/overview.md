...
-   *A statistics file:* The `output/statistics` file contains statistics
    ...
    :::{note}
    As noted in {ref}`sec:methods:dimensionalize`, ASPECT can be thought of as using the meter-kilogramsecond
